...
UW_HUD_WaveCounter_C['On Current Wave Changed'] = function(GameState) end
---@param TransitionTag FGameplayTag
---@param Additional_Tags FGameplayTagContainer
UW_HUD_WaveCounter_C['On Transition Finished'] = function(TransitionTag, Additional_Tags) end
