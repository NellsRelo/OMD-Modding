...
UGA_Gabby_Ultimate_C['Increment Mesmerize Stats'] = function(Character) end
---@param Source UAbilitySystemComponent
---@param Target AActor
---@return boolean
UGA_Gabby_Ultimate_C['Is Target Valid'] = function(Source, Target) end
---@param Targets FGameplayAbilityTargetDataHandle
UGA_Gabby_Ultimate_C['Perform Mesmerize'] = function(Targets) end
...
UGA_Gabby_Ultimate_C['Filter Targets'] = function(TargetData, MesmerizeTargets, NonMesmerizeTargets) end
---@return FGameplayAbilityTargetDataHandle
UGA_Gabby_Ultimate_C['Gather Targets'] = function() end
...
UGA_Gabby_Ultimate_C['On Mesmerized Minion Died'] = function(OwningActor) end
UGA_Gabby_Ultimate_C['Start Move Slow'] = function() end
UGA_Gabby_Ultimate_C['Stop Move Slow'] = function() end
---@param Tag FGameplayTag
function UGA_Gabby_Ultimate_C:BP_PerformTaggedPrediction(Tag) end
UGA_Gabby_Ultimate_C['Hide Wand'] = function() end
UGA_Gabby_Ultimate_C['Show Wand'] = function() end
UGA_Gabby_Ultimate_C['Track Mesmerize Stat'] = function() end
