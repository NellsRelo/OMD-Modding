...
function UW_HealthComponentDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_3(HealthComponent, OldValue, NewValue, Instigator,
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_HealthComponentDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_2(HealthComponent, OldValue, NewValue, Instigator,
                                                                         HitResult, bHasSpec, Spec) end
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_HealthComponentDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_1(HealthComponent, OldValue, NewValue, Instigator,
                                                                         HitResult, bHasSpec, Spec) end
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_HealthComponentDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_0(HealthComponent, OldValue, NewValue, Instigator,
                                                                         HitResult, bHasSpec, Spec) end
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_HealthComponentDisplay_Base_C:OnHealthMaxChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult,
                                                             bHasSpec, Spec) end
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_HealthComponentDisplay_Base_C:OnHealthChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult,
                                                          bHasSpec, Spec) end
...
UW_HealthComponentDisplay_Base_C['Play Anim If Valid'] = function(self, InAnimation) end
---@param IsDisplaying boolean
