...
UGA_Wand_Special_Projectile_C['Get Target Socket'] = function(Actor, Target_Comp) end
---@param Actor AActor
---@param Target_Comp FVector
UGA_Wand_Special_Projectile_C['Get Target Socket Location'] = function(Actor, Target_Comp) end
---@param Actor AActor
---@param Target_Comp USceneComponent
UGA_Wand_Special_Projectile_C['Get Target Component'] = function(Actor, Target_Comp) end
---@param Target AActor
---@param bValid boolean
UGA_Wand_Special_Projectile_C['Is Valid Target'] = function(Target, bValid) end
---@param Actor AActor
---@param Distance double
UGA_Wand_Special_Projectile_C['Calc Distance'] = function(Actor, Distance) end
---@param Actor AActor
UGA_Wand_Special_Projectile_C['Get Closest Line of Sight Actor'] = function(Actor) end
...
UGA_Wand_Special_Projectile_C['Projectile Destroyed'] = function(DestroyedActor) end
---@param bWasCancelled boolean
function UGA_Wand_Special_Projectile_C:K2_OnEndAbility(bWasCancelled) end
---@param Targets TArray<AActor>
UGA_Wand_Special_Projectile_C['On Targets Acquired'] = function(Targets) end
---@param Targets TArray<AActor>
UGA_Wand_Special_Projectile_C['On Targets Removed'] = function(Targets) end
---@param Target AActor
