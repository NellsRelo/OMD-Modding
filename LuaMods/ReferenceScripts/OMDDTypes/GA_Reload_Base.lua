...
UGA_Reload_Base_C['Get Reload Cue'] = function(self, Cue) end
---@param ActorInfo FGameplayAbilityActorInfo
---@param bHasFullClip boolean
UGA_Reload_Base_C['Has Full Clip'] = function(self, ActorInfo, bHasFullClip) end
---@param ActorInfo FGameplayAbilityActorInfo
...
UGA_Reload_Base_C['Perform Reload'] = function(self,) end
UGA_Reload_Base_C['Start Reload Montage'] = function(self,) end
UGA_Reload_Base_C['Start Input Deferral'] = function(self,) end
UGA_Reload_Base_C['Perform Auth Reload'] = function(self,) end
UGA_Reload_Base_C['Grant Charges'] = function(self,) end
UGA_Reload_Base_C['Do Reload Internal'] = function(self,) end
