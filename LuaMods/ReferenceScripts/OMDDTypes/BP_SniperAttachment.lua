...
ABP_SniperAttachment_C['Get Fire Montage'] = function(self, Selection, Fire_Montage) end
...
ABP_SniperAttachment_C['Update Sniper Visuals'] = function(self, SniperFX) end
