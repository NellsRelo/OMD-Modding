...
---@return boolean
function UW_ChallengeRunSelect_C:BP_OnHandleBackAction() end
---@param Loaded UObject
function UW_ChallengeRunSelect_C:OnLoaded_439FD44C4F57868546D848B640B00A06(Loaded) end
function UW_ChallengeRunSelect_C:BndEvt__W_ChallengeRunSelect_EscButton_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature() end
...
function UW_ChallengeRunSelect_C:BndEvt__W_ChallengeRunSelect_TabButton_K2Node_ComponentBoundEvent_2_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param Button UCommonButtonBase
function UW_ChallengeRunSelect_C:BndEvt__W_ChallengeRunSelect_Button_ClientReady_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature(Button) end
function UW_ChallengeRunSelect_C:UpdateShareCode() end
---@param Button UCommonButtonBase
function UW_ChallengeRunSelect_C:BndEvt__W_ChallengeRunSelect_W_ButtonBasic_K2Node_ComponentBoundEvent_4_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param Button UCommonButtonBase
function UW_ChallengeRunSelect_C:BndEvt__W_ChallengeRunSelect_PasteCodeButton_K2Node_ComponentBoundEvent_5_CommonButtonBaseClicked__DelegateSignature(Button) end
---@param TabIndex int32
UW_ChallengeRunSelect_C['BndEvt__W_ChallengeRunSelect_W_ChallengeRun_TopBar_K2Node_ComponentBoundEvent_6_On Tab Selected__DelegateSignature'] = function(TabIndex) end
...
function UW_ChallengeRunSelect_C:MakeChallengeRunActive() end
