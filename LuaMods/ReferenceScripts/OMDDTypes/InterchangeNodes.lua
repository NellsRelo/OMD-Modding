...
---@return boolean
function UInterchangeSceneNode:GetCustomTimeZeroGlobalTransform(BaseNodeContainer, GlobalOffsetTransform, AttributeValue,
                                                                bForceRecache) end
...
---@param bForceRecache boolean
---@return boolean
function UInterchangeSceneNode:GetCustomGlobalTransform(BaseNodeContainer, GlobalOffsetTransform, AttributeValue,
                                                        bForceRecache) end
...
---@param bForceRecache boolean
---@return boolean
function UInterchangeSceneNode:GetCustomBindPoseGlobalTransform(BaseNodeContainer, GlobalOffsetTransform, AttributeValue,
                                                                bForceRecache) end
...
---@param InType EInterchangeAnimationPayLoadType
---@return boolean
function UInterchangeSkeletalAnimationTrackNode:SetAnimationPayloadKeyForMorphTargetNodeUid(MorphTargetNodeUid,
                                                                                            InUniqueId, InType) end
...
function UInterchangeSkeletalAnimationTrackNode:GetSceneNodeAnimationPayloadKeys(OutSceneNodeAnimationPayloadKeyUids,
                                                                                 OutSceneNodeAnimationPayloadKeyTypes) end
...
function UInterchangeSkeletalAnimationTrackNode:GetMorphTargetNodeAnimationPayloadKeys(
    OutMorphTargetNodeAnimationPayloadKeyUids, OutMorphTargetNodeAnimationPayloadKeyTypes) end
