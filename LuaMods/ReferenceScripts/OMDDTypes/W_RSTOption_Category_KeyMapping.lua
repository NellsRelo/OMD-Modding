...
---@field NewEventDispatcher FW_RSTOption_Category_KeyMapping_CNewEventDispatcher
...
function UW_RSTOption_Category_KeyMapping_C:NewEventDispatcher__DelegateSignature() end
