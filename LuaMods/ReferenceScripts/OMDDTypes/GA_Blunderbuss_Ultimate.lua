...
UGA_Blunderbuss_Ultimate_C['Destroy Spawned Actor'] = function() end
---@param OriginalActor ARNetworkProxyActor
---@param NetworkedActor ARNetworkProxyActor
UGA_Blunderbuss_Ultimate_C['On Replacement Spawned'] = function(OriginalActor, NetworkedActor) end
UGA_Blunderbuss_Ultimate_C['Execute Application Effects'] = function() end
