...
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Start Tracking Ability State'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Stop Tracking Ability State'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Get Initial Ability State'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Refresh Internal State'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Trigger Refire Delay'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Start Tracking Dormant Tags'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Dormant Tags Present'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Dormant Tags Removed'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Try Cancel Ability'] = function(self,) end
UGA_Blunderbuss_Pet_TargetAcquisition_Base_C['Stop Tracking Dormant Tags'] = function(self,) end
...
function UGA_Blunderbuss_Pet_TargetAcquisition_Base_C:ExecuteUbergraph_GA_Blunderbuss_Pet_TargetAcquisition_Base(
    EntryPoint) end
