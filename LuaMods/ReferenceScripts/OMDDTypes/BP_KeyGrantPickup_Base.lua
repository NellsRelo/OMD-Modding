...
ABP_KeyGrantPickup_Base_C['Perform Key Grant'] = function(self, Player) end
---@param Controller APlayerController
---@param bAllowed boolean
ABP_KeyGrantPickup_Base_C['Is Key Grant Allowed'] = function(self, Controller, bAllowed) end
