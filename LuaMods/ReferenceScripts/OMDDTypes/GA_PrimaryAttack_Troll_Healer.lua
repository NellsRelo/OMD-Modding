...
function UGA_PrimaryAttack_Troll_Healer_C:OnReadyToFire_9C1F58F34DD151D6A49B4FBC9B91421A(HitActor, HitLocation, bDealDamage) end
...
---@param bDealDamage boolean
UGA_PrimaryAttack_Troll_Healer_C['Process Fire Target'] = function(Hit_Actor, Hit_Location, bDealDamage) end
---@param Actor AActor
---@param bDealDamage boolean
UGA_PrimaryAttack_Troll_Healer_C['Apply Damage Effects'] = function(Actor, bDealDamage) end
---@param Target AActor
