...
---@return FGameplayTag
ABP_SentinelTrapBase_C['Get Summon Tag'] = function(self,) end
...
ABP_SentinelTrapBase_C['Process Allow Interaction'] = function(self,) end
function ABP_SentinelTrapBase_C:ReceiveBeginPlay() end

---@param Tag FGameplayTag
function ABP_SentinelTrapBase_C:BP_NotifyPropertyModified(Tag) end
