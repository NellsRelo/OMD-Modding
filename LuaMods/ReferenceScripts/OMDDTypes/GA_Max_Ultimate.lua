...
UGA_Max_Ultimate_C['Apply Ultimate Active Effects'] = function(self,) end
UGA_Max_Ultimate_C['Remove Ultimate Active Effects'] = function(self,) end
UGA_Max_Ultimate_C['Cancel Linked Abilities'] = function(self,) end
