...
---@field __EnumProperty_25 EAnimSyncMethod
---@field __ByteProperty_26 EAnimGroupRole::Type
...
---@field ['Root Pos'] FVector
---@field ['Has Root'] boolean
UABP_Blunderbuss_Pet_Ultimate_C = {}
