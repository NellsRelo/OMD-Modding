...
---@class ABP_DisplayCase_6x10_A_C : ABP_OMDTrapGrid_C
---@field Orc_Decor4 UStaticMeshComponent
---@field Lizardman_Horn_D UStaticMeshComponent
---@field Lizardman_Horn_C UStaticMeshComponent
---@field Lizardman_Horn_B UStaticMeshComponent
---@field Lizardman_Horn_A UStaticMeshComponent
---@field Orc_Alarm UStaticMeshComponent
---@field ORC_WarCampDoor UStaticMeshComponent
---@field ThroneBionka_Cinematic UStaticMeshComponent
---@field ThroneBionka UStaticMeshComponent
