...
---@return boolean
UGCN_Character_Hit_Enemy_C['Is Local Player'] = function(NewParam) end
---@param PlayerState APlayerState
---@return boolean
UGCN_Character_Hit_Enemy_C['Is Local Player State'] = function(PlayerState) end
---@param Parameters FGameplayCueParameters
---@param Player_State APlayerState
UGCN_Character_Hit_Enemy_C['Get Associated Player'] = function(Parameters, Player_State) end
---@param Selection FGameplayCueParameters
---@param Cue USoundBase
UGCN_Character_Hit_Enemy_C['Select Remote (3D) Sound Cue'] = function(Selection, Cue) end
---@param Selection FGameplayCueParameters
---@param Cue USoundBase
UGCN_Character_Hit_Enemy_C['Select Instigator (2D) Sound Cue'] = function(Selection, Cue) end
---@param Enemy AActor
---@param Parameters FGameplayCueParameters
