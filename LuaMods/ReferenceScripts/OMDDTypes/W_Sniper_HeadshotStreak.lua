...
UW_Sniper_HeadshotStreak_C['Refresh Active State'] = function(bNewActive) end
---@param bIsCapped boolean
UW_Sniper_HeadshotStreak_C['Refresh Capped State'] = function(bIsCapped) end
UW_Sniper_HeadshotStreak_C['Stop Streak Anims'] = function() end
function UW_Sniper_HeadshotStreak_C:Construct() end
---@param Count int32
---@param bActive boolean
---@param bCapped boolean
UW_Sniper_HeadshotStreak_C['Update Display'] = function(Count, bActive, bCapped) end
---@param Count int32
---@param bActive boolean
UW_Sniper_HeadshotStreak_C['Update Text'] = function(Count, bActive) end
