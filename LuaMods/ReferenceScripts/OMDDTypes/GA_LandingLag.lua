...
UGA_LandingLag_C['Is Ground Hit'] = function(Hit, bIsGround) end
function UGA_LandingLag_C:OnSync_E603CF2D4B37CC8CD505DCBB631E184E() end
function UGA_LandingLag_C:K2_ActivateAbility() end
UGA_LandingLag_C['Finished Falling'] = function() end
---@param Hit FHitResult
UGA_LandingLag_C['On Character Landed'] = function(Hit) end
