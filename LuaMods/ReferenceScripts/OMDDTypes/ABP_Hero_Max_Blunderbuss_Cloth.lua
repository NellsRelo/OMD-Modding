...
UABP_Hero_Max_Blunderbuss_Cloth_C = {}

---@param InPose FPoseLink
---@param AnimGraph FPoseLink
function UABP_Hero_Max_Blunderbuss_Cloth_C:AnimGraph(InPose, AnimGraph) end

---@param EntryPoint int32
function UABP_Hero_Max_Blunderbuss_Cloth_C:ExecuteUbergraph_ABP_Hero_Max_Blunderbuss_Cloth(EntryPoint) end
