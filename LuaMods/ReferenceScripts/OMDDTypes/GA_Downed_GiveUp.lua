...
UGA_Downed_GiveUp_C['On Charge Finished'] = function(self,) end
UGA_Downed_GiveUp_C['Start Charge Timer'] = function(self,) end
UGA_Downed_GiveUp_C['Send Charging UI Message'] = function(self,) end
UGA_Downed_GiveUp_C['Cancel Charging UI Message'] = function(self,) end
UGA_Downed_GiveUp_C['Finish Charging UI Message'] = function(self,) end
UGA_Downed_GiveUp_C['Perform Give Up'] = function(self,) end
