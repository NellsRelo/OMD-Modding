...
UABP_Hero_Sniper_Physics_C = {}

---@param InPose FPoseLink
---@param AnimGraph FPoseLink
function UABP_Hero_Sniper_Physics_C:AnimGraph(InPose, AnimGraph) end
---@param EntryPoint int32
function UABP_Hero_Sniper_Physics_C:ExecuteUbergraph_ABP_Hero_Sniper_Physics(EntryPoint) end
