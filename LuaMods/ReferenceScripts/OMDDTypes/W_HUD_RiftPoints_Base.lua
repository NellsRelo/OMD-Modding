...
UW_HUD_RiftPoints_Base_C['Rift Protection Status Changed'] = function(bProtectionActive) end
function UW_HUD_RiftPoints_Base_C:OnInitialized() end
---@param Value int32
UW_HUD_RiftPoints_Base_C['Initial Rift Points Set'] = function(Value) end
UW_HUD_RiftPoints_Base_C['Init Game State Listeners'] = function() end
