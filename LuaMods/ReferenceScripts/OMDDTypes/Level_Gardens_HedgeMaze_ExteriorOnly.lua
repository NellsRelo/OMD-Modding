...
ALevel_Gardens_HedgeMaze_ExteriorOnly_C['BeginOverlap-Spikes'] = function(OverlappedActor, OtherActor) end
---@param OverlappedActor AActor
---@param OtherActor AActor
ALevel_Gardens_HedgeMaze_ExteriorOnly_C['BeginOverlap-Fire'] = function(OverlappedActor, OtherActor) end
