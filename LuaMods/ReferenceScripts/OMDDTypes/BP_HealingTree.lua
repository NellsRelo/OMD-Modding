...
ABP_HealingTree_C['Filter Adjacent Trap'] = function(Trap, bValid) end
---@param bValid boolean
ABP_HealingTree_C['Valid for Additional Effects'] = function(bValid) end
---@return boolean
...
function ABP_HealingTree_C:BndEvt__BP_TimeCrystals_QueryBox1_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult) end
---@param OverlappedComponent UPrimitiveComponent
---@param OtherActor AActor
---@param OtherComp UPrimitiveComponent
---@param OtherBodyIndex int32
---@param bFromSweep boolean
---@param SweepResult FHitResult
function ABP_HealingTree_C:BndEvt__BP_TimeCrystals_QueryBox2_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex, bFromSweep, SweepResult) end
---@param Trap ARSTTrap
...
---@param OtherComp UPrimitiveComponent
---@param OtherBodyIndex int32
function ABP_HealingTree_C:BndEvt__BP_TimeCrystals_QueryBox1_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex) end
---@param OverlappedComponent UPrimitiveComponent
---@param OtherActor AActor
---@param OtherComp UPrimitiveComponent
---@param OtherBodyIndex int32
function ABP_HealingTree_C:BndEvt__BP_TimeCrystals_QueryBox2_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature(OverlappedComponent, OtherActor, OtherComp, OtherBodyIndex) end
---@param Actor AActor
ABP_HealingTree_C['Try Apply Additional Effects'] = function(Actor) end
ABP_HealingTree_C['Apply Additional Effects to All Targets'] = function() end
ABP_HealingTree_C['Remove Additional Effects from All Targets'] = function() end
---@param bForce boolean
ABP_HealingTree_C['Refresh Additional Effects'] = function(bForce) end
...
ABP_HealingTree_C['Sell Timeline Update'] = function(Opacity) end
ABP_HealingTree_C['Sell Timeline__FinishedFunc'] = function() end
