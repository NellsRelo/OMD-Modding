...
---@param Target AActor
---@return boolean
UGA_Death_Orc_Unstable_C['Allowed Trap Disable Objects'] = function(self, Source, Target) end
---@param Source UAbilitySystemComponent
---@param Target AActor
---@return boolean
UGA_Death_Orc_Unstable_C['Allowed Crystal Objects'] = function(self, Source, Target) end
...
---@param Target AActor
---@return boolean
UGA_Death_Orc_Unstable_C['Allowed Player Objects'] = function(self, Source, Target) end
