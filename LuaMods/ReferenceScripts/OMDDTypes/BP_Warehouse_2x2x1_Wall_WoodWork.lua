...
---@class ABP_Warehouse_2x2x1_Wall_WoodWork_C : ABP_OMDTrapGrid_C
...
---@field Warehouse_2x2x1_Wall_WoodWork_SM UStaticMeshComponent
...
ABP_Warehouse_2x2x1_Wall_WoodWork_C = {}
