...
UGA_Recharge_Base_C['On Charge Count Updated'] = function(InChargeTag) end
UGA_Recharge_Base_C['Unregister Change Callback'] = function() end
UGA_Recharge_Base_C['Register Change Callback'] = function() end
---@param MaxCharges int32
UGA_Recharge_Base_C['Get Max Charges'] = function(MaxCharges) end
---@param Charges int32
UGA_Recharge_Base_C['Get Current Charges'] = function(Charges) end
...
UGA_Recharge_Base_C['Add Charge'] = function() end
UGA_Recharge_Base_C['Cancel Add Charge'] = function() end
UGA_Recharge_Base_C['Grant Additional Charge'] = function() end
UGA_Recharge_Base_C['Signal Charge Awarded'] = function() end
UGA_Recharge_Base_C['Signal Recharge Started'] = function() end
UGA_Recharge_Base_C['Signal Charge Cancelled'] = function() end
UGA_Recharge_Base_C['Clear Wait Sync'] = function() end
function UGA_Recharge_Base_C:K2_OnNewAvatarSet() end
UGA_Recharge_Base_C['Listen for Cooldown Reduction'] = function() end
UGA_Recharge_Base_C['Clear Cooldown Reduction Listener'] = function() end
