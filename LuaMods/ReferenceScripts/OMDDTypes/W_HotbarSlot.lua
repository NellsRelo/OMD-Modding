...
---@return boolean
UW_HotbarSlot_C['Has Enough Coin'] = function(self,) end
---@return boolean
...
---@param Loaded UClass
function UW_HotbarSlot_C:OnLoaded_AF59B8134057A2555C6267B4D9932D7F(Loaded) end
...
UW_HotbarSlot_C['On Trap Limit Changed'] = function(self, PlayerState) end
UW_HotbarSlot_C['On Player State Changed'] = function(self,) end
UW_HotbarSlot_C['Unbind Player State'] = function(self,) end
---@param PlayerState APlayerState
UW_HotbarSlot_C['Bind Player State'] = function(self, PlayerState) end
---@param OldPawn APawn
---@param NewPawn APawn
...
UW_HotbarSlot_C['On Trap Placement Bonus Changed'] = function(self,) end
UW_HotbarSlot_C['Update Trap Cost'] = function(self,) end
UW_HotbarSlot_C['Configure Icon'] = function(self,) end
UW_HotbarSlot_C['On Shared Placement Changed'] = function(self,) end
UW_HotbarSlot_C['Bind Game State Callbacks'] = function(self,) end
UW_HotbarSlot_C['Unbind Game State Callbacks'] = function(self,) end
UW_HotbarSlot_C['Bind Player Controller Callbacks'] = function(self,) end
UW_HotbarSlot_C['Unbind Player Controller Callbacks'] = function(self,) end
