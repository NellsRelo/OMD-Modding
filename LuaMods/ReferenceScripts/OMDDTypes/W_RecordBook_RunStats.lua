...
UW_RecordBook_RunStats_C['Add Potion Item'] = function(self,) end
...
---@param Output int32
UW_RecordBook_RunStats_C['Display to Array Index'] = function(self, IndexToTest, Output) end
...
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_EnemiesKilled_K2Node_ComponentBoundEvent_2_OnRequestCustomDisplay__DelegateSignature(
    SelfDisplay) end

---@param SelfDisplay UW_RecordBook_StatEntry_C
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_TrapDamage_K2Node_ComponentBoundEvent_3_OnRequestCustomDisplay__DelegateSignature(
    SelfDisplay) end

---@param SelfDisplay UW_RecordBook_StatEntry_C
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_WarMageDamage_K2Node_ComponentBoundEvent_4_OnRequestCustomDisplay__DelegateSignature(
    SelfDisplay) end
...
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_LeftArrow_K2Node_ComponentBoundEvent_5_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_RightArrow_K2Node_ComponentBoundEvent_6_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param SelfDisplay UW_RecordBook_StatEntry_C
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_CompletedMissions_K2Node_ComponentBoundEvent_1_OnRequestCustomDisplay__DelegateSignature(
    SelfDisplay) end

---@param Button UCommonButtonBase
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_MissionLeftArrow_K2Node_ComponentBoundEvent_11_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_MissionRightArrow_K2Node_ComponentBoundEvent_12_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param SelfDisplay UW_RecordBook_StatEntry_C
function UW_RecordBook_RunStats_C:BndEvt__W_RecordBook_RunStats_W_RecordBook_StatEntry_K2Node_ComponentBoundEvent_0_OnRequestCustomDisplay__DelegateSignature(
    SelfDisplay) end

UW_RecordBook_RunStats_C['Refresh Mission Buttons'] = function(self,) end
UW_RecordBook_RunStats_C['Refresh Thread Buttons'] = function(self,) end
---@param Left UWidget
---@param Right UWidget
---@param Switcher UWidgetSwitcher
UW_RecordBook_RunStats_C['Refresh Buttons'] = function(self, Left, Right, Switcher) end
---@param ThisButton UW_RecordBook_LastRun_PlayerButton_C
UW_RecordBook_RunStats_C['BndEvt__W_RecordBook_RunStats_Player1_K2Node_ComponentBoundEvent_13_On Clicked__DelegateSignature'] = function(
    self, ThisButton) end
---@param ThisButton UW_RecordBook_LastRun_PlayerButton_C
UW_RecordBook_RunStats_C['BndEvt__W_RecordBook_RunStats_HostPlayer_K2Node_ComponentBoundEvent_14_On Clicked__DelegateSignature'] = function(
    self, ThisButton) end
---@param ThisButton UW_RecordBook_LastRun_PlayerButton_C
UW_RecordBook_RunStats_C['BndEvt__W_RecordBook_RunStats_Player2_K2Node_ComponentBoundEvent_15_On Clicked__DelegateSignature'] = function(
    self, ThisButton) end
---@param ThisButton UW_RecordBook_LastRun_PlayerButton_C
UW_RecordBook_RunStats_C['BndEvt__W_RecordBook_RunStats_Player3_K2Node_ComponentBoundEvent_16_On Clicked__DelegateSignature'] = function(
    self, ThisButton) end
