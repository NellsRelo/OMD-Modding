...
---@class UABP_Orc_Unstable_Secondary_C : URSTAnimInstancePostProcess
...
UABP_Orc_Unstable_Secondary_C = {}

---@param InPose FPoseLink
---@param AnimGraph FPoseLink
function UABP_Orc_Unstable_Secondary_C:AnimGraph(InPose, AnimGraph) end

function UABP_Orc_Unstable_Secondary_C:BlueprintBeginPlay() end

---@param EntryPoint int32
function UABP_Orc_Unstable_Secondary_C:ExecuteUbergraph_ABP_Orc_Unstable_Secondary(EntryPoint) end
