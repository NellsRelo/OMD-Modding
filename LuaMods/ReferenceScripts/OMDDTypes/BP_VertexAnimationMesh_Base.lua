...
ABP_VertexAnimationMesh_Base_C['Montage Started'] = function(self, Montage) end
---@param Montage UAnimMontage
---@param bInterrupted boolean
ABP_VertexAnimationMesh_Base_C['Montage Ended'] = function(self, Montage, bInterrupted) end
