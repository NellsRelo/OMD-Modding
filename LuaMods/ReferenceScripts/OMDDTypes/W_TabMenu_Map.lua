...
UW_TabMenu_Map_C['Sync Map Legends'] = function(Target) end
function UW_TabMenu_Map_C:BP_OnActivated() end
UW_TabMenu_Map_C['Refresh Wave'] = function() end
---@param GameState ARSTGameStateBase
UW_TabMenu_Map_C['Wave Updated'] = function(GameState) end
function UW_TabMenu_Map_C:BP_OnDeactivated() end
UW_TabMenu_Map_C['Update Legend Entry Visibility'] = function() end
