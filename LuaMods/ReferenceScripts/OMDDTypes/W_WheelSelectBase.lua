...
function UW_WheelSelectBase_C:InpActEvt_IA_UI_Gamepad_Cursor_K2Node_EnhancedInputActionEvent_2(ActionValue, ElapsedTime,
                                                                                               TriggeredTime,
                                                                                               SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function UW_WheelSelectBase_C:InpActEvt_IA_UI_Gamepad_Cursor_K2Node_EnhancedInputActionEvent_1(ActionValue, ElapsedTime,
                                                                                               TriggeredTime,
                                                                                               SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function UW_WheelSelectBase_C:InpActEvt_IA_UI_Gamepad_Cursor_K2Node_EnhancedInputActionEvent_0(ActionValue, ElapsedTime,
                                                                                               TriggeredTime,
                                                                                               SourceAction) end
