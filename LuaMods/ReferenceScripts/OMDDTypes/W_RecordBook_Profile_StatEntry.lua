...
UW_RecordBook_Profile_StatEntry_C['Refresh Stat Value'] = function(self,) end
UW_RecordBook_Profile_StatEntry_C['Setup Custom Value Display'] = function(self,) end
UW_RecordBook_Profile_StatEntry_C['Set Empty Display'] = function(self,) end
---@param InputPin FGameplayTagContainer
UW_RecordBook_Profile_StatEntry_C['Process Tag Value'] = function(self, InputPin) end
---@param InText FText
UW_RecordBook_Profile_StatEntry_C['Set Custom Display'] = function(self, InText) end
---@param UFD URSTPawnUserFacingData
---@param bFound boolean
UW_RecordBook_Profile_StatEntry_C['Process User Data Found'] = function(self, UFD, bFound) end
---@param Item URSTInventoryItemDefinition
---@param bFound boolean
UW_RecordBook_Profile_StatEntry_C['Process Inventory Data Found'] = function(self, Item, bFound) end
---@param Name FText
---@param BrushObject UObject
UW_RecordBook_Profile_StatEntry_C['Populate From Tag Data'] = function(self, Name, BrushObject) end
---@param Value int32
UW_RecordBook_Profile_StatEntry_C['Process Stat Value'] = function(self, Value) end
