...
UGA_Crossbow_Secondary_Laser_C['Hide Reticle'] = function(self,) end
UGA_Crossbow_Secondary_Laser_C['Clear Laser Cue'] = function(self,) end
UGA_Crossbow_Secondary_Laser_C['Start Laser Visuals'] = function(self,) end
UGA_Crossbow_Secondary_Laser_C['Show Reticle'] = function(self,) end
function UGA_Crossbow_Secondary_Laser_C:RequestDialogue() end

---@param Target AActor
UGA_Crossbow_Secondary_Laser_C['Apply Damage'] = function(self, Target) end
---@param Actor AActor
