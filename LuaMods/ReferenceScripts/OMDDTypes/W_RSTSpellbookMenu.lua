...
UW_RSTSpellbookMenu_C['Get Empty Text'] = function(self, bUseEmptyText, Empty_Text) end
---@param Element UObject
---@param Should_Enable boolean
UW_RSTSpellbookMenu_C['Should Enable Contents for Element'] = function(self, Element, Should_Enable) end
---@param Element UObject
---@param Should_Enable boolean
UW_RSTSpellbookMenu_C['Should Element Be Spawned'] = function(self, Element, Should_Enable) end
---@return UWidget
...
UW_RSTSpellbookMenu_C['BndEvt__W_RSTSpellbookMenu_W_RSTSpellbook_CategorySwitcher_K2Node_ComponentBoundEvent_4_On Category Selected__DelegateSignature'] = function(
    self, Category) end
---@param Grid_Element UW_PurchaseMenu_GridElement_C
UW_RSTSpellbookMenu_C['BndEvt__W_RSTSpellbookMenu_TrapGrid_K2Node_ComponentBoundEvent_0_Grid Element Hovered__DelegateSignature'] = function(
    self, Grid_Element) end
UW_RSTSpellbookMenu_C['Listen for Spellbook Operation'] = function(self,) end
UW_RSTSpellbookMenu_C['Clear Spellbook Operation Listener'] = function(self,) end
UW_RSTSpellbookMenu_C['Listen for Loadout Change'] = function(self,) end
UW_RSTSpellbookMenu_C['Clear Loadout Change  Listener'] = function(self,) end
