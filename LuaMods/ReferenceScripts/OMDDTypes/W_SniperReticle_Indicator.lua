...
UW_SniperReticle_Indicator_C['Trigger Hit Indicator'] = function(Style, Priority) end
---@param Tags FGameplayTagContainer
UW_SniperReticle_Indicator_C['Play Hit'] = function(Tags) end
UW_SniperReticle_Indicator_C['Listen For Hit Messages'] = function() end
function UW_SniperReticle_Indicator_C:OnInitialized() end
UW_SniperReticle_Indicator_C['Update Obstructed Display'] = function() end
function UW_SniperReticle_Indicator_C:Construct() end
---@param OldPawn APawn
---@param NewPawn APawn
UW_SniperReticle_Indicator_C['On Refresh Pawn'] = function(OldPawn, NewPawn) end
