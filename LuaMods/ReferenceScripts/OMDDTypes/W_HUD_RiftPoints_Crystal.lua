...
function UW_HUD_RiftPoints_Crystal_C:CREATEDELEGATE_PROXYFUNCTION_0(NewRemaining, RemainingRatio, DamageTaken, DamageRatio) end
UW_HUD_RiftPoints_Crystal_C['Init Crystal Defense Component'] = function() end
---@param Health double
---@param HealthRatio double
---@param Damage double
---@param DamageRatio double
UW_HUD_RiftPoints_Crystal_C['On Rift Health Updated'] = function(Health, HealthRatio, Damage, DamageRatio) end
UW_HUD_RiftPoints_Crystal_C['Init Game State Listeners'] = function() end
