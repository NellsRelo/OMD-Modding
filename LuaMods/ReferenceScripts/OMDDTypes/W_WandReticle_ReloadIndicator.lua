...
UW_WandReticle_ReloadIndicator_C['On Reload Started'] = function(self, InputPin) end
---@param InputPin FWandReload_InputMessage
UW_WandReticle_ReloadIndicator_C['On Reload Input'] = function(self, InputPin) end
---@param InputPin FWandReload_RemoveDisplayMessage
UW_WandReticle_ReloadIndicator_C['On Reload Finished'] = function(self, InputPin) end
---@param MyGeometry FGeometry
---@param InDeltaTime float
function UW_WandReticle_ReloadIndicator_C:Tick(MyGeometry, InDeltaTime) end

UW_WandReticle_ReloadIndicator_C['Update Cursor Display'] = function(self,) end
