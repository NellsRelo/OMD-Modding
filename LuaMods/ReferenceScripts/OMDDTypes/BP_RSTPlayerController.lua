...
function ABP_RSTPlayerController_C:InpActEvt_IA_ToggleTabMenu_K2Node_EnhancedInputActionEvent_6(ActionValue, ElapsedTime,
                                                                                                TriggeredTime,
                                                                                                SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_TabMenu_Hero_K2Node_EnhancedInputActionEvent_5(ActionValue, ElapsedTime,
                                                                                               TriggeredTime,
                                                                                               SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_TabMenu_Map_K2Node_EnhancedInputActionEvent_4(ActionValue, ElapsedTime,
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_TabMenu_Thread_K2Node_EnhancedInputActionEvent_3(ActionValue, ElapsedTime,
                                                                                                 TriggeredTime,
                                                                                                 SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_TabMenu_Trap_K2Node_EnhancedInputActionEvent_2(ActionValue, ElapsedTime,
                                                                                               TriggeredTime,
                                                                                               SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_ToggleInGameMenu_K2Node_EnhancedInputActionEvent_1(ActionValue,
                                                                                                   ElapsedTime,
                                                                                                   TriggeredTime,
                                                                                                   SourceAction) end
...
---@param TriggeredTime float
---@param SourceAction UInputAction
function ABP_RSTPlayerController_C:InpActEvt_IA_RemoveInGameMenu_K2Node_EnhancedInputActionEvent_0(ActionValue,
                                                                                                   ElapsedTime,
                                                                                                   TriggeredTime,
                                                                                                   SourceAction) end
...
ABP_RSTPlayerController_C['Try Show Unlocked Threads'] = function(self,) end
function ABP_RSTPlayerController_C:ReceiveDestroyed() end

---@param Tag FGameplayTag
ABP_RSTPlayerController_C['On Layer Active Widget Changed'] = function(self, Tag) end
ABP_RSTPlayerController_C['On Grant Popup Finished'] = function(self,) end
ABP_RSTPlayerController_C['Register Widget Changed Callback'] = function(self,) end
ABP_RSTPlayerController_C['Unregister Widget Changed Callback'] = function(self,) end
---@param bIsShowing boolean
ABP_RSTPlayerController_C['Loading Screen Status Changed'] = function(self, bIsShowing) end
ABP_RSTPlayerController_C['Try Process Popups'] = function(self,) end
---@param Condition boolean
---@param WidgetClass TSoftClassPtr<UCommonActivatableWidget>
ABP_RSTPlayerController_C['Try Show Popup'] = function(self, Condition, WidgetClass) end
ABP_RSTPlayerController_C['Clear Existing Menus'] = function(self,) end
