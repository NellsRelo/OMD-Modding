...
UW_PurchaseMenu_Potion_C['Should Enable Contents for Element'] = function(self, Element, Should_Enable) end
---@param Object UObject
---@param Text FText
UW_PurchaseMenu_Potion_C['Get Purchase Text'] = function(self, Object, Text) end
UW_PurchaseMenu_Potion_C['Perform Yes Button Clicked'] = function(self,) end
---@param Yes_Visibility ESlateVisibility
UW_PurchaseMenu_Potion_C['Can Show Yes Button'] = function(self, Yes_Visibility) end
UW_PurchaseMenu_Potion_C['Load Grid Objects'] = function(self,) end
---@param Object UObject
UW_PurchaseMenu_Potion_C['On Object Selected'] = function(self, Object) end
