...
UW_AbilityDisplaySlot_RiftBurst_C['Register Message Callbacks'] = function(self,) end
---@param InputPin FRSTAbilityDurationMessage
UW_AbilityDisplaySlot_RiftBurst_C['Charging Message Received'] = function(self, InputPin) end
---@param InputPin FRSTAbilityDurationMessage
UW_AbilityDisplaySlot_RiftBurst_C['Cooldown Message Received'] = function(self, InputPin) end
UW_AbilityDisplaySlot_RiftBurst_C['Charging Finished Received'] = function(self,) end
UW_AbilityDisplaySlot_RiftBurst_C['On Cooldown Finished'] = function(self,) end
---@param Timer_Active boolean
---@param InputPin float
---@param Show_Display boolean
UW_AbilityDisplaySlot_RiftBurst_C['Init Timer'] = function(self, Timer_Active, InputPin, Show_Display) end
---@param MyGeometry FGeometry
---@param InDeltaTime float
function UW_AbilityDisplaySlot_RiftBurst_C:Tick(MyGeometry, InDeltaTime) end

---@param Percent float
UW_AbilityDisplaySlot_RiftBurst_C['Set Charge Indicator Percent'] = function(self, Percent) end
UW_AbilityDisplaySlot_RiftBurst_C['Refresh Charge Count'] = function(self,) end
