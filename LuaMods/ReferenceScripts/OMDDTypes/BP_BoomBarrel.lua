...
function ABP_BoomBarrel_C:BndEvt__BP_BoomBarrel_HealthComponent_K2Node_ComponentBoundEvent_3_RSTHealth_DeathEvent__DelegateSignature(
    OwningActor, Instigator) end

---@param OwningActor AActor
---@param Instigator AActor
function ABP_BoomBarrel_C:BndEvt__BP_BoomBarrel_HealthComponent_K2Node_ComponentBoundEvent_4_RSTHealth_DeathEvent__DelegateSignature(
    OwningActor, Instigator) end
...
function ABP_BoomBarrel_C:BndEvt__BP_BoomBarrel_PhysicsHandler_K2Node_ComponentBoundEvent_7_ComponentEndOverlapSignature__DelegateSignature(
...
function ABP_BoomBarrel_C:BndEvt__BP_BoomBarrel_PhysicsHandler_K2Node_ComponentBoundEvent_8_ComponentBeginOverlapSignature__DelegateSignature(
