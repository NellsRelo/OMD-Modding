...
IRadial_Storm_Sky_Interface_C['Update with Sky Mode Change'] = function(Successful) end
...
IRadial_Storm_Sky_Interface_C['Get Cloud Coverage Brush Data'] = function(UDS, Soft_Fraction, RGBA, World_Location, Size, UDS_Coverage_Level) end
