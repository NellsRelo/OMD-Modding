...
---@class UHero_AimOffset_IKOffhandFix_RR_C : UControlRig
---@field PreIkRot FQuat
UHero_AimOffset_IKOffhandFix_RR_C = {}



---@class URigVMMemory_Literal : URigVMMemoryStorage
---@field RigVMModel___RigUnit_GetTransform_3_Item__Const FRigElementKey
---@field RigVMModel___RigUnit_GetTransform_3_Space__Const ERigVMTransformSpace
---@field RigVMModel___RigUnit_GetTransform_3_bInitial__Const boolean
---@field RigVMModel___TwoBoneIKSimplePerItem_ItemB__Const FRigElementKey
---@field RigVMModel___TwoBoneIKSimplePerItem_EffectorItem__Const FRigElementKey
...
---@field RigVMModel___TwoBoneIKSimplePerItem_PrimaryAxis__Const FVector
---@field RigVMModel___TwoBoneIKSimplePerItem_SecondaryAxis__Const FVector
---@field RigVMModel___TwoBoneIKSimplePerItem_SecondaryAxisWeight__Const float
---@field RigVMModel___RigUnit_GetTransform_1_Item__Const FRigElementKey
---@field RigVMModel___TwoBoneIKSimplePerItem_PoleVectorKind__Const EControlRigVectorKind
---@field RigVMModel___TwoBoneIKSimplePerItem_PoleVectorSpace__Const FRigElementKey
---@field RigVMModel___TwoBoneIKSimplePerItem_StretchStartRatio__Const float
---@field RigVMModel___TwoBoneIKSimplePerItem_StretchMaximumRatio__Const float
---@field RigVMModel___TwoBoneIKSimplePerItem_ItemALength__Const float
---@field RigVMModel___TwoBoneIKSimplePerItem_bPropagateToChildren__Const boolean
---@field RigVMModel___TwoBoneIKSimplePerItem_DebugSettings__Const FRigUnit_TwoBoneIKSimple_DebugSettings
---@field RigVMModel___RigUnit_OffsetTransformForItem_2_OffsetTransform__Const FTransform
---@field RigVMModel___Make_Absolute_Parent__Const FTransform
...
---@field RigVMModel___TwoBoneIKSimplePerItem_PoleVector FVector
---@field RigVMModel___TwoBoneIKSimplePerItem_CachedItemAIndex TArray<FCachedRigElement>
---@field RigVMModel___TwoBoneIKSimplePerItem_CachedItemBIndex TArray<FCachedRigElement>
...
---@field RigVMModel___RigVMFunction_MathQuaternionSwingTwist_Swing FQuat
...
---@field RigVMModel___Inverse_Result FQuat
