...
function UW_QuicksaveButton_C:BndEvt__W_LoadQuicksaveButton_LoadSoloButton_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_QuicksaveButton_C:BndEvt__W_LoadQuicksaveButton_LoadSaveButton_K2Node_ComponentBoundEvent_2_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_QuicksaveButton_C:BndEvt__W_LoadQuicksaveButton_DeleteSaveButton_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(
    Button) end

function UW_QuicksaveButton_C:UpdateVisuals() end

---@param Button UCommonButtonBase
function UW_QuicksaveButton_C:BndEvt__W_LoadQuicksaveButton_RenameSaveButton_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature(
    Button) end
