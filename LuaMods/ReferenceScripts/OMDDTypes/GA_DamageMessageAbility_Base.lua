...
---@param Valid boolean
UGA_DamageMessageAbility_Base_C['Check Trap Instigator'] = function(Instigator, InstigatorTags, Valid) end
---@param Target UObject
---@param TargetTags FGameplayTagContainer
---@param bValid boolean
UGA_DamageMessageAbility_Base_C['Check Target'] = function(Target, TargetTags, bValid) end
---@param Instigator UObject
---@param InstigatorTags FGameplayTagContainer
---@param bValid boolean
UGA_DamageMessageAbility_Base_C['Check Instigator'] = function(Instigator, InstigatorTags, bValid) end
---@param Payload FRSTDamageMessage
---@param bValid boolean
UGA_DamageMessageAbility_Base_C['Check Ability Filter'] = function(Payload, bValid) end
---@param Payload FRSTDamageMessage
---@param bValid boolean
UGA_DamageMessageAbility_Base_C['Is Relevant Event'] = function(Payload, bValid) end
...
---@param Payload FRSTDamageMessage
UGA_DamageMessageAbility_Base_C['Process Event'] = function(Payload) end
