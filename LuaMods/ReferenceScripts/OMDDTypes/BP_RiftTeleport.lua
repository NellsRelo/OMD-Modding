...
ABP_RiftTeleport_C['Update Rift Target'] = function(self,) end
---@param Actor AActor
ABP_RiftTeleport_C['Apply Additional Effects'] = function(self, Actor) end
---@param ExistingRiftTargets TArray<ARSTRift>
function ABP_RiftTeleport_C:GetExistingRiftTargets(ExistingRiftTargets) end

ABP_RiftTeleport_C['Update Rift Arrow'] = function(self,) end
---@return boolean
