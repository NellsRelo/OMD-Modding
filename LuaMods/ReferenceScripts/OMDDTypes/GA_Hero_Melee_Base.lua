...
UGA_Hero_Melee_Base_C['Is Valid Target'] = function(self, Actor, bValid) end
---@param Angle double
---@param Forward_Vector FVector
UGA_Hero_Melee_Base_C['Get Rotation Forward'] = function(self, Angle, Forward_Vector) end
---@param ActorsLeft TArray<AActor>
---@param ActorsRight TArray<AActor>
---@param Joined_Array TArray<AActor>
UGA_Hero_Melee_Base_C['Combine Arrays'] = function(self, ActorsLeft, ActorsRight, Joined_Array) end
---@param Actor AActor
---@param Distance double
UGA_Hero_Melee_Base_C['Get Actor Distance'] = function(self, Actor, Distance) end
---@param Actors TArray<AActor>
---@param Closest_Actor AActor
UGA_Hero_Melee_Base_C['Get Closest Actor'] = function(self, Actors, Closest_Actor) end
---@return AActor
