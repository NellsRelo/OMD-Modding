...
function UW_RSTOption_KeyRemap_C:BndEvt__W_RSTOption_KeyRemap_InputKeySelector_389_K2Node_ComponentBoundEvent_0_OnKeySelected__DelegateSignature(
    SelectedKey) end

---@param Button UCommonButtonBase
function UW_RSTOption_KeyRemap_C:BndEvt__W_RSTOption_KeyRemap_W_ButtonBasic_K2Node_ComponentBoundEvent_2_CommonButtonBaseClicked__DelegateSignature(
    Button) end
