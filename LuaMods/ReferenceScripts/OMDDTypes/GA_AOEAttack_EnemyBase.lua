...
---@param Target AActor
---@return boolean
UGA_AOEAttack_EnemyBase_C['Can Damage AOE Target'] = function(self, Source, Target) end
---@param ASC UAbilitySystemComponent
---@param bCanAffect boolean
UGA_AOEAttack_EnemyBase_C['Can Affect Target'] = function(self, ASC, bCanAffect) end
