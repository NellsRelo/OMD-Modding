...
function ABP_HammerDecoy_C:BndEvt__BP_HammerDecoy_HealthComponent_K2Node_ComponentBoundEvent_0_RSTHealth_DeathEvent__DelegateSignature(
    OwningActor, Instigator) end

---@param OwningActor AActor
---@param Instigator AActor
function ABP_HammerDecoy_C:BndEvt__BP_HammerDecoy_HealthComponent_K2Node_ComponentBoundEvent_1_RSTHealth_DeathEvent__DelegateSignature(
    OwningActor, Instigator) end

---@param InputPin AActor
ABP_HammerDecoy_C['Check Expired Tag'] = function(self, InputPin) end
function ABP_HammerDecoy_C:UpdateNearbyActors() end
