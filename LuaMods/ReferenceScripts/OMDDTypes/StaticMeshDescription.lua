...
function UStaticMeshDescription:CreateCube(Center, HalfExtents, PolygonGroup, PolygonID_PlusX, PolygonID_MinusX,
                                           PolygonID_PlusY, PolygonID_MinusY, PolygonID_PlusZ, PolygonID_MinusZ) end
