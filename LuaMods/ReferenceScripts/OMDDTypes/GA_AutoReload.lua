...
---@param Time double
UGA_AutoReload_C['Get Time Since Activation'] = function(self, Time) end
...
UGA_AutoReload_C['Try Perform Reload'] = function(self,) end
UGA_AutoReload_C['Listen for Attempt Reload'] = function(self,) end
UGA_AutoReload_C['Clear Reload Event Task'] = function(self,) end
