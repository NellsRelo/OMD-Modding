...
UGA_DownedBurst_Base_C['On Charge Finished'] = function(self,) end
UGA_DownedBurst_Base_C['Start Charge FX'] = function(self,) end
UGA_DownedBurst_Base_C['Stop Charge FX'] = function(self,) end
UGA_DownedBurst_Base_C['Trigger Fire FX'] = function(self,) end
UGA_DownedBurst_Base_C['Start Montage'] = function(self,) end
UGA_DownedBurst_Base_C['Play Outro'] = function(self,) end
UGA_DownedBurst_Base_C['Start Charge Timer'] = function(self,) end
UGA_DownedBurst_Base_C['Send Charging UI Message'] = function(self,) end
...
UGA_DownedBurst_Base_C['Do Blast'] = function(self,) end
UGA_DownedBurst_Base_C['Cancel Charging UI Message'] = function(self,) end
UGA_DownedBurst_Base_C['Send Cooldown UI Message'] = function(self,) end
UGA_DownedBurst_Base_C['Finish Charing UI Message'] = function(self,) end
