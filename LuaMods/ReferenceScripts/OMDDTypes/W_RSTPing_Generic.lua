...
UW_RSTPing_Generic_C['Get Distance To Pawn'] = function(bSuccess, Distance) end
---@param PinStickHeight double
UW_RSTPing_Generic_C['Get Pin Stick Height'] = function(PinStickHeight) end
UW_RSTPing_Generic_C['Update Display'] = function() end
...
UW_RSTPing_Generic_C['Init Centered'] = function() end
---@param MyGeometry FGeometry
---@param InDeltaTime float
function UW_RSTPing_Generic_C:Tick(MyGeometry, InDeltaTime) end
UW_RSTPing_Generic_C['Stop State Anims'] = function() end
