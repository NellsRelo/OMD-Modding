...
function UW_Modal_Credits_C:BndEvt__W_Modal_Credits_W_ButtonBasic_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param CurrentOffset float
function UW_Modal_Credits_C:BndEvt__W_Modal_Credits_ScrollBox_131_K2Node_ComponentBoundEvent_1_OnUserScrolledEvent__DelegateSignature(
    CurrentOffset) end
