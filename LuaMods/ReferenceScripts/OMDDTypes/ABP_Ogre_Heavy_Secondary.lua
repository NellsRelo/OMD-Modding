...
---@class UABP_Ogre_Heavy_Secondary_C : URSTAnimInstancePostProcess
...
UABP_Ogre_Heavy_Secondary_C = {}

---@param InPose FPoseLink
---@param AnimGraph FPoseLink
function UABP_Ogre_Heavy_Secondary_C:AnimGraph(InPose, AnimGraph) end
function UABP_Ogre_Heavy_Secondary_C:BlueprintBeginPlay() end
---@param EntryPoint int32
function UABP_Ogre_Heavy_Secondary_C:ExecuteUbergraph_ABP_Ogre_Heavy_Secondary(EntryPoint) end
