...
---@class UABP_Kobold_Runner_Secondary_C : URSTAnimInstancePostProcess
...
UABP_Kobold_Runner_Secondary_C = {}

---@param InPose FPoseLink
---@param AnimGraph FPoseLink
function UABP_Kobold_Runner_Secondary_C:AnimGraph(InPose, AnimGraph) end

function UABP_Kobold_Runner_Secondary_C:BlueprintBeginPlay() end

---@param EntryPoint int32
function UABP_Kobold_Runner_Secondary_C:ExecuteUbergraph_ABP_Kobold_Runner_Secondary(EntryPoint) end
