...
FGeometryScriptBakeRenderCaptureOptions = {}
...
FGeometryScriptBakeSourceMeshOptions = {}



---@class FGeometryScriptBakeTargetMeshOptions
---@field TargetUVLayer int32
FGeometryScriptBakeTargetMeshOptions = {}
...
---@field ProjectionDistance float
---@field bProjectionInWorldSpace boolean
FGeometryScriptBakeVertexOptions = {}
...
FGeometryScriptConstrainedDelaunayTriangulationOptions = {}
...
FGeometryScriptGeneralPolygonList = {}
...
---@field bInferMaterialID boolean
---@field SetMaterialID int32
FGeometryScriptMeshBevelSelectionOptions = {}
...
FGeometryScriptMeshEditPolygroupOptions = {}
...
---@field UVScale float
FGeometryScriptMeshInsetOutsetFacesOptions = {}
...
---@field UVScale float
---@field bSolidsToShells boolean
FGeometryScriptMeshOffsetFacesOptions = {}
...
FGeometryScriptMeshPointSamplingOptions = {}
...
FGeometryScriptOpenPathOffsetOptions = {}
...
FGeometryScriptPolygonsTriangulationOptions = {}
...
---@field UVScale FVector2D
---@field UVOffset FVector2D
FGeometryScriptSampleTextureOptions = {}
...
---@field EmptyBehavior EGeometryScriptEmptySelectionBehavior
FGeometryScriptSelectiveTessellateOptions = {}
...
FGeometryScriptSmoothBoneWeightsOptions = {}
...
FGeometryScriptSplineSamplingOptions = {}
...
FGeometryScriptTransferBoneWeightsOptions = {}
...
FGeometryScriptUniformRemeshOptions = {}
...
---@return UDynamicMesh
function UGeometryScriptLibrary_CollisionFunctions:SetStaticMeshCollisionFromMesh(FromDynamicMesh, ToStaticMeshAsset,
                                                                                  Options, Debug) end
...
---@param Debug UGeometryScriptDebug
function UGeometryScriptLibrary_CollisionFunctions:SetStaticMeshCollisionFromComponent(StaticMeshAsset, SourceComponent,
                                                                                       Options, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_CollisionFunctions:SetDynamicMeshCollisionFromMesh(FromDynamicMesh,
                                                                                   ToDynamicMeshComponent, Options, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_ContainmentFunctions:ComputeMeshSweptHull(TargetMesh, CopyToMesh, CopyToMeshOut,
                                                                          ProjectionFrame, Options, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_ContainmentFunctions:ComputeMeshConvexHull(TargetMesh, CopyToMesh, CopyToMeshOut,
                                                                           Selection, Options, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_ContainmentFunctions:ComputeMeshConvexDecomposition(TargetMesh, CopyToMesh, CopyToMeshOut,
                                                                                    Options, Debug) end
...
function UGeometryScriptLibrary_ListUtilityFunctions:ExtractColorListChannels(ColorList, VectorList, XChannelIndex,
                                                                              YChannelIndex, ZChannelIndex) end
...
---@return FGeometryScriptBakeTypeOptions
function UGeometryScriptLibrary_MeshBakeFunctions:MakeBakeTypeCurvature(CurvatureType, ColorMapping, ColorRangeMultiplier,
                                                                        MinRangeMultiplier, Clamping) end
...
---@return FGeometryScriptBakeTypeOptions
function UGeometryScriptLibrary_MeshBakeFunctions:MakeBakeTypeAmbientOcclusion(OcclusionRays, MaxDistance, SpreadAngle,
                                                                               BiasAngle) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBakeFunctions:BakeVertex(TargetMesh, TargetTransform, TargetOptions, SourceMesh,
                                                             SourceTransform, SourceOptions, BakeTypes, BakeOptions,
                                                             Debug) end
...
function UGeometryScriptLibrary_MeshBakeFunctions:BakeTextureFromRenderCaptures(TargetMesh, TargetLocalToWorld,
                                                                                TargetOptions, SourceActors, BakeOptions,
                                                                                Debug) end
...
function UGeometryScriptLibrary_MeshBakeFunctions:BakeTexture(TargetMesh, TargetTransform, TargetOptions, SourceMesh,
                                                              SourceTransform, SourceOptions, BakeTypes, BakeOptions,
                                                              Debug) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:SetVertexPosition(TargetMesh, VertexID, NewPosition,
                                                                         bIsValidVertex, bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:DeleteVerticesFromMesh(TargetMesh, VertexList, NumDeleted,
                                                                              bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:DeleteVertexFromMesh(TargetMesh, VertexID, bWasVertexDeleted,
                                                                            bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:DeleteTrianglesFromMesh(TargetMesh, TriangleList, NumDeleted,
                                                                               bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:DeleteTriangleFromMesh(TargetMesh, TriangleID, bWasTriangleDeleted,
                                                                              bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:DeleteSelectedTrianglesFromMesh(TargetMesh, Selection, NumDeleted,
                                                                                       bDeferChangeNotifications) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AppendMeshTransformed(TargetMesh, AppendMesh, AppendTransforms,
                                                                             ConstantTransform,
                                                                             bConstantTransformIsRelative,
                                                                             bDeferChangeNotifications, AppendOptions,
                                                                             Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AppendMeshRepeated(TargetMesh, AppendMesh, AppendTransform,
                                                                          RepeatCount, bApplyTransformToFirstInstance,
                                                                          bDeferChangeNotifications, AppendOptions, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AppendMesh(TargetMesh, AppendMesh, AppendTransform,
                                                                  bDeferChangeNotifications, AppendOptions, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AppendBuffersToMesh(TargetMesh, Buffers, NewTriangleIndicesList,
                                                                           MaterialID, bDeferChangeNotifications, Debug) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AddVerticesToMesh(TargetMesh, NewPositionsList, NewIndicesList,
                                                                         bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AddVertexToMesh(TargetMesh, NewPosition, NewVertexIndex,
                                                                       bDeferChangeNotifications) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AddTriangleToMesh(TargetMesh, NewTriangle, NewTriangleIndex,
                                                                         NewTriangleGroupID, bDeferChangeNotifications,
                                                                         Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBasicEditFunctions:AddTrianglesToMesh(TargetMesh, NewTrianglesList, NewIndicesList,
                                                                          NewTriangleGroupID, bDeferChangeNotifications,
                                                                          Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:TransferBoneWeightsFromMesh(SourceMesh, TargetMesh, Options,
                                                                                    Debug) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:SetVertexBoneWeights(TargetMesh, VertexID, BoneWeights,
                                                                             bIsValidVertexID, Profile) end
...
---@param Profile FGeometryScriptBoneWeightProfile
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:MeshCreateBoneWeights(TargetMesh, bProfileExisted,
                                                                              bReplaceExistingProfile, Profile) end
...
---@param Profile FGeometryScriptBoneWeightProfile
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetVertexBoneWeights(TargetMesh, VertexID, BoneWeights,
                                                                             bHasValidBoneWeights, Profile) end
...
---@param Profile FGeometryScriptBoneWeightProfile
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetMaxBoneWeightIndex(TargetMesh, bHasBoneWeights, MaxBoneIndex,
                                                                              Profile) end
...
---@param Profile FGeometryScriptBoneWeightProfile
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetLargestVertexBoneWeight(TargetMesh, VertexID, BoneWeight,
                                                                                   bHasValidBoneWeights, Profile) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetBoneInfo(TargetMesh, BoneName, bIsValidBoneName, BoneInfo,
                                                                    Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetBoneIndex(TargetMesh, BoneName, bIsValidBoneName, BoneIndex,
                                                                     Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:GetBoneChildren(TargetMesh, BoneName, bRecursive,
                                                                        bIsValidBoneName, ChildrenInfo, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBoneWeightFunctions:ComputeSmoothBoneWeights(TargetMesh, Skeleton, Options, Profile,
                                                                                 Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshBooleanFunctions:ApplyMeshBoolean(TargetMesh, TargetTransform, ToolMesh,
                                                                      ToolTransform, Operation, Options, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshComparisonFunctions:MeasureDistancesBetweenMeshes(TargetMesh, OtherMesh, Options,
                                                                                      MaxDistance, MinDistance,
                                                                                      AverageDistance,
                                                                                      RootMeanSqrDeviation, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshComparisonFunctions:IsIntersectingMesh(TargetMesh, TargetTransform, OtherMesh,
                                                                           OtherTransform, bIsIntersecting, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDecompositionFunctions:SplitMeshByPolygroups(TargetMesh, GroupLayer, ComponentMeshes,
                                                                                 ComponentPolygroups, MeshPool, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDecompositionFunctions:SplitMeshByMaterialIDs(TargetMesh, ComponentMeshes,
                                                                                  ComponentMaterialIDs, MeshPool, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDecompositionFunctions:SplitMeshByComponents(TargetMesh, ComponentMeshes, MeshPool,
                                                                                 Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDecompositionFunctions:GetSubMeshFromMesh(TargetMesh, StoreToSubmesh, TriangleList,
                                                                              StoreToSubmeshOut, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDecompositionFunctions:CopyMeshSelectionToMesh(TargetMesh, StoreToSubmesh, Selection,
                                                                                   StoreToSubmeshOut, bAppendToExisting,
                                                                                   bPreserveGroupIDs, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyTwistWarpToMesh(TargetMesh, Options, TwistOrientation,
                                                                         TwistAngle, TwistExtent, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyMathWarpToMesh(TargetMesh, WarpOrientation, WarpType, Options,
                                                                        Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyFlareWarpToMesh(TargetMesh, Options, FlareOrientation,
                                                                         FlarePercentX, FlarePercentY, FlareExtent, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyDisplaceFromTextureMap(TargetMesh, Texture, Selection, Options,
                                                                                UVLayer, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyDisplaceFromPerVertexVectors(TargetMesh, Selection, VectorList,
                                                                                      Magnitude, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshDeformFunctions:ApplyBendWarpToMesh(TargetMesh, Options, BendOrientation, BendAngle,
                                                                        BendExtent, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshGeodesicFunctions:GetShortestVertexPath(TargetMesh, StartVertexID, EndVertexID,
                                                                            VertexIDList, bFoundErrors, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshGeodesicFunctions:GetShortestSurfacePath(TargetMesh, StartTriangleID, StartBaryCoords,
                                                                             EndTriangleID, EndBaryCoords, ShortestPath,
                                                                             bFoundErrors, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshGeodesicFunctions:CreateSurfacePath(TargetMesh, Direction, StartTriangleID,
                                                                        StartBaryCoords, MaxPathLength, SurfacePath,
                                                                        bFoundErrors, Debug) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:SetTriangleMaterialID(TargetMesh, TriangleID, MaterialID,
                                                                            bIsValidTriangle, bDeferChangeNotifications) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:SetPolygroupMaterialID(TargetMesh, GroupLayer, PolygroupID,
                                                                             MaterialID, bIsValidPolygroupID,
                                                                             bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:SetMaterialIDOnTriangles(TargetMesh, TriangleIDList, MaterialID,
                                                                               bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:SetMaterialIDForMeshSelection(TargetMesh, Selection, MaterialID,
                                                                                    bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:SetAllTriangleMaterialIDs(TargetMesh, TriangleMaterialIDList,
                                                                                bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:GetTrianglesByMaterialID(TargetMesh, MaterialID, TriangleIDList,
                                                                               Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:GetMaterialIDsOfTriangles(TargetMesh, TriangleIDList,
                                                                                MaterialIDList, Debug) end

---@param TargetMesh UDynamicMesh
---@param MaterialIDList FGeometryScriptIndexList
---@param bHasMaterialIDs boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:GetAllTriangleMaterialIDs(TargetMesh, MaterialIDList,
                                                                                bHasMaterialIDs) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:DeleteTrianglesByMaterialID(TargetMesh, MaterialID, NumDeleted,
                                                                                  bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshMaterialFunctions:CompactMaterialIDs(TargetMesh, SourceMaterialList,
                                                                         CompactedMaterialList, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshModelingFunctions:ApplyMeshDuplicateFaces(TargetMesh, Selection, NewTriangles,
                                                                              GroupOptions, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshModelingFunctions:ApplyMeshDisconnectFaces(TargetMesh, Selection,
                                                                               bAllowBowtiesInOutput, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshModelingFunctions:ApplyMeshBevelSelection(TargetMesh, Selection, BevelMode,
                                                                              BevelOptions, Debug) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:UpdateVertexNormal(TargetMesh, VertexID, bUpdateNormal, NewNormal,
                                                                        bUpdateTangents, NewTangentX, NewTangentY,
                                                                        bIsValidVertex, bMergeSplitValues,
                                                                        bDeferChangeNotifications) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:SetMeshTriangleNormals(TargetMesh, TriangleID, Normals,
                                                                            bIsValidTriangle, bDeferChangeNotifications) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:SetMeshPerVertexTangents(TargetMesh, TangentXList, TangentYList,
                                                                              Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:RecomputeNormalsForMeshSelection(TargetMesh, Selection,
                                                                                      CalculateOptions,
                                                                                      bDeferChangeNotifications, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:RecomputeNormals(TargetMesh, CalculateOptions,
                                                                      bDeferChangeNotifications, Debug) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:GetMeshPerVertexTangents(TargetMesh, TangentXList, TangentYList,
                                                                              bIsValidTangentSet, bHasVertexIDGaps,
                                                                              bAverageSplitVertexValues) end
...
---@param bAverageSplitVertexValues boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:GetMeshPerVertexNormals(TargetMesh, NormalList, bIsValidNormalSet,
                                                                             bHasVertexIDGaps, bAverageSplitVertexValues) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshNormalsFunctions:ComputeSplitNormals(TargetMesh, SplitOptions, CalculateOptions,
                                                                         Debug) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:SetPolygroupForMeshSelection(TargetMesh, GroupLayer, Selection,
                                                                                    SetPolygroupIDOut, SetPolygroupID,
                                                                                    bGenerateNewPolygroup,
                                                                                    bDeferChangeNotifications) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:GetTrianglesInPolygroup(TargetMesh, GroupLayer, PolygroupID,
                                                                               TriangleIDsOut) end
...
---@param bIsValidTriangle boolean
---@return int32
function UGeometryScriptLibrary_MeshPolygroupFunctions:GetTrianglePolygroupID(TargetMesh, GroupLayer, TriangleID,
                                                                              bIsValidTriangle) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:DeleteTrianglesInPolygroup(TargetMesh, GroupLayer, PolygroupID,
                                                                                  NumDeleted, bDeferChangeNotifications,
                                                                                  Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:CopyPolygroupsLayer(TargetMesh, FromGroupLayer, ToGroupLayer,
                                                                           Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:ConvertUVIslandsToPolygroups(TargetMesh, GroupLayer, UVLayer,
                                                                                    Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:ComputePolygroupsFromPolygonDetection(TargetMesh, GroupLayer,
                                                                                             bRespectUVSeams,
                                                                                             bRespectHardNormals,
                                                                                             QuadAdjacencyWeight,
                                                                                             QuadMetricClamp,
                                                                                             MaxSearchRounds, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPolygroupFunctions:ComputePolygroupsFromAngleThreshold(TargetMesh, GroupLayer,
                                                                                           CreaseAngle, MinGroupSize,
                                                                                           Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendVoronoiDiagram2D(TargetMesh, PrimitiveOptions, Transform,
                                                                              VoronoiSites, VoronoiOptions, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendTriangulatedPolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                                 PolygonVertices, bAllowSelfIntersections,
                                                                                 Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendTorus(TargetMesh, PrimitiveOptions, Transform,
                                                                   RevolveOptions, MajorRadius, MinorRadius, MajorSteps,
                                                                   MinorSteps, Origin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSweepPolyline(TargetMesh, PrimitiveOptions, Transform,
                                                                           PolylineVertices, SweepPath, PolylineTexParamU,
                                                                           SweepPathTexParamV, bLoop, StartScale,
                                                                           EndScale, RotationAngleDeg, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSweepPolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                          PolygonVertices, SweepPath, bLoop, bCapped,
                                                                          StartScale, EndScale, RotationAngleDeg, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSpiralRevolvePolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                                  PolygonVertices, RevolveOptions, Radius,
                                                                                  Steps, RisePerRevolution, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSphereLatLong(TargetMesh, PrimitiveOptions, Transform,
                                                                           Radius, StepsPhi, StepsTheta, Origin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSphereBox(TargetMesh, PrimitiveOptions, Transform, Radius,
                                                                       StepsX, StepsY, StepsZ, Origin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSimpleSweptPolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                                PolygonVertices, SweepPath, bLoop,
                                                                                bCapped, StartScale, EndScale, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendSimpleExtrudePolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                                  PolygonVertices, Height, HeightSteps,
                                                                                  bCapped, Origin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRoundRectangleXY(TargetMesh, PrimitiveOptions, Transform,
                                                                              DimensionX, DimensionY, CornerRadius,
                                                                              StepsWidth, StepsHeight, StepsRound, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRoundRectangle_Compatibility_5_0(TargetMesh,
                                                                                              PrimitiveOptions, Transform,
                                                                                              DimensionX, DimensionY,
                                                                                              CornerRadius, StepsWidth,
                                                                                              StepsHeight, StepsRound,
                                                                                              Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRevolvePolygon(TargetMesh, PrimitiveOptions, Transform,
                                                                            PolygonVertices, RevolveOptions, Radius,
                                                                            Steps, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRevolvePath(TargetMesh, PrimitiveOptions, Transform,
                                                                         PathVertices, RevolveOptions, Steps, bCapped,
                                                                         Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRectangleXY(TargetMesh, PrimitiveOptions, Transform,
                                                                         DimensionX, DimensionY, StepsWidth, StepsHeight,
                                                                         Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendRectangle_Compatibility_5_0(TargetMesh, PrimitiveOptions,
                                                                                         Transform, DimensionX,
                                                                                         DimensionY, StepsWidth,
                                                                                         StepsHeight, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendPolygonListTriangulation(TargetMesh, PrimitiveOptions,
                                                                                      Transform, PolygonList,
                                                                                      TriangulationOptions,
                                                                                      bTriangulationError, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendLinearStairs(TargetMesh, PrimitiveOptions, Transform,
                                                                          StepWidth, StepHeight, StepDepth, NumSteps,
                                                                          bFloating, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendDisc(TargetMesh, PrimitiveOptions, Transform, Radius,
                                                                  AngleSteps, SpokeSteps, StartAngle, EndAngle,
                                                                  HoleRadius, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendDelaunayTriangulation2D(TargetMesh, PrimitiveOptions,
                                                                                     Transform, VertexPositions,
                                                                                     ConstrainedEdges,
                                                                                     TriangulationOptions,
                                                                                     PositionsToVertexIDs,
                                                                                     bHasDuplicateVertices, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendCylinder(TargetMesh, PrimitiveOptions, Transform, Radius,
                                                                      Height, RadialSteps, HeightSteps, bCapped, Origin,
                                                                      Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendCurvedStairs(TargetMesh, PrimitiveOptions, Transform,
                                                                          StepWidth, StepHeight, InnerRadius, CurveAngle,
                                                                          NumSteps, bFloating, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendCone(TargetMesh, PrimitiveOptions, Transform, BaseRadius,
                                                                  TopRadius, Height, RadialSteps, HeightSteps, bCapped,
                                                                  Origin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendCapsule(TargetMesh, PrimitiveOptions, Transform, Radius,
                                                                     LineLength, HemisphereSteps, CircleSteps, Origin,
                                                                     Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendBox(TargetMesh, PrimitiveOptions, Transform, DimensionX,
                                                                 DimensionY, DimensionZ, StepsX, StepsY, StepsZ, Origin,
                                                                 Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshPrimitiveFunctions:AppendBoundingBox(TargetMesh, PrimitiveOptions, Transform, Box,
                                                                         StepsX, StepsY, StepsZ, Debug) end
...
---@return FBox2D
function UGeometryScriptLibrary_MeshQueryFunctions:GetUVSetBoundingBox(TargetMesh, UvSetIndex, bIsValidUVSet,
                                                                       bUVSetIsEmpty) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetTriangleVertexColors(TargetMesh, TriangleID, Color1, Color2, Color3,
                                                                           bTriHasValidVertexColors) end
...
function UGeometryScriptLibrary_MeshQueryFunctions:GetTriangleUVs(TargetMesh, UvSetIndex, TriangleID, UV1, UV2, UV3,
                                                                  bHaveValidUVs) end
...
function UGeometryScriptLibrary_MeshQueryFunctions:GetTrianglePositions(TargetMesh, TriangleID, bIsValidTriangle, Vertex1,
                                                                        Vertex2, Vertex3) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetTriangleNormalTangents(TargetMesh, TriangleID, bTriHasValidElements,
                                                                             Normals, Tangents, BiTangents) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetTriangleNormals(TargetMesh, TriangleID, Normal1, Normal2, Normal3,
                                                                      bTriHasValidNormals) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetInterpolatedTriangleVertexColor(TargetMesh, TriangleID,
                                                                                      BarycentricCoords, DefaultColor,
                                                                                      bTriHasValidVertexColors,
                                                                                      InterpolatedColor) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetInterpolatedTriangleUV(TargetMesh, UvSetIndex, TriangleID,
                                                                             BarycentricCoords, bTriHasValidUVs,
                                                                             InterpolatedUV) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetInterpolatedTrianglePosition(TargetMesh, TriangleID,
                                                                                   BarycentricCoords, bIsValidTriangle,
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetInterpolatedTriangleNormalTangents(TargetMesh, TriangleID,
                                                                                         BarycentricCoords,
                                                                                         bTriHasValidElements,
                                                                                         InterpolatedNormal,
                                                                                         InterpolatedTangent,
                                                                                         InterpolatedBiTangent) end
...
---@param InterpolatedNormal FVector
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetInterpolatedTriangleNormal(TargetMesh, TriangleID,
                                                                                 BarycentricCoords, bTriHasValidNormals,
                                                                                 InterpolatedNormal) end
...
---@param bHasVertexIDGaps boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetAllVertexPositions(TargetMesh, PositionList, bSkipGaps,
                                                                         bHasVertexIDGaps) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetAllTriangleIndices(TargetMesh, TriangleList, bSkipGaps,
                                                                         bHasTriangleIDGaps) end
...
---@param bHaveValidUVs boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:GetAllSplitUVsAtVertex(TargetMesh, UvSetIndex, VertexID, ElementIDs,
                                                                          ElementUVs, bHaveValidUVs) end
...
---@param BarycentricCoords FVector
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshQueryFunctions:ComputeTriangleBarycentricCoords(TargetMesh, TriangleID,
                                                                                    bIsValidTriangle, Point, Vertex1,
                                                                                    Vertex2, Vertex3, BarycentricCoords) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshRepairFunctions:FillAllMeshHoles(TargetMesh, FillOptions, NumFilledHoles,
                                                                     NumFailedHoleFills, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSamplingFunctions:ComputeVertexWeightedPointSampling(TargetMesh, Options,
                                                                                         NonUniformOptions, VertexWeights,
                                                                                         Samples, SampleRadii,
                                                                                         TriangleIDs, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSamplingFunctions:ComputePointSampling(TargetMesh, Options, Samples, TriangleIDs,
                                                                           Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSamplingFunctions:ComputeNonUniformPointSampling(TargetMesh, Options,
                                                                                     NonUniformOptions, Samples,
                                                                                     SampleRadii, TriangleIDs, Debug) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:SelectMeshElementsWithPlane(TargetMesh, Selection, PlaneOrigin,
                                                                                   PlaneNormal, SelectionType, bInvert,
                                                                                   MinNumTrianglePoints) end
...
---@param MinNumTrianglePoints int32
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:SelectMeshElementsInSphere(TargetMesh, Selection, SphereOrigin,
                                                                                  SphereRadius, SelectionType, bInvert,
                                                                                  MinNumTrianglePoints) end
...
---@param MinNumTrianglePoints int32
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:SelectMeshElementsInsideMesh(TargetMesh, SelectionMesh, Selection,
                                                                                    SelectionMeshTransform, SelectionType,
                                                                                    bInvert, ShellDistance,
                                                                                    WindingThreshold,
                                                                                    MinNumTrianglePoints) end
...
---@param MinNumTrianglePoints int32
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:SelectMeshElementsInBox(TargetMesh, Selection, Box, SelectionType,
                                                                               bInvert, MinNumTrianglePoints) end
...
---@param MinNumTrianglePoints int32
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:SelectMeshElementsByNormalAngle(TargetMesh, Selection, Normal,
                                                                                       MaxAngleDeg, SelectionType,
                                                                                       bInvert, MinNumTrianglePoints) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:InvertMeshSelection(TargetMesh, Selection, NewSelection,
                                                                           bOnlyToConnected) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ExpandMeshSelectionToConnected(TargetMesh, Selection, NewSelection,
                                                                                      ConnectionType) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ExpandContractMeshSelection(TargetMesh, Selection, NewSelection,
                                                                                   Iterations, bContract,
                                                                                   bOnlyExpandToFaceNeighbours) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertMeshSelectionToIndexList(TargetMesh, Selection, IndexList,
                                                                                       ResultListType, ConvertToType) end
...
---@param SelectionType EGeometryScriptMeshSelectionType
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertMeshSelectionToIndexArray(TargetMesh, Selection, IndexArray,
                                                                                        SelectionType) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertMeshSelection(TargetMesh, FromSelection, ToSelection,
                                                                            NewType, bAllowPartialInclusion) end
...
---@param Selection FGeometryScriptMeshSelection
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertIndexSetToMeshSelection(TargetMesh, IndexSet, SelectionType,
                                                                                      Selection) end
...
---@param Selection FGeometryScriptMeshSelection
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertIndexListToMeshSelection(TargetMesh, IndexList,
                                                                                       SelectionType, Selection) end
...
---@param Selection FGeometryScriptMeshSelection
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionFunctions:ConvertIndexArrayToMeshSelection(TargetMesh, IndexArray,
                                                                                        SelectionType, Selection) end
...
function UGeometryScriptLibrary_MeshSelectionFunctions:CombineMeshSelections(SelectionA, SelectionB, ResultSelection,
                                                                             CombineMode) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionQueryFunctions:GetMeshSelectionBoundingBox(TargetMesh, Selection,
                                                                                        SelectionBounds, bIsEmpty, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSelectionQueryFunctions:GetMeshSelectionBoundaryLoops(TargetMesh, Selection,
                                                                                          IndexLoops, PathLoops, NumLoops,
                                                                                          bFoundErrors, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSimplifyFunctions:ApplySimplifyToTriangleCount(TargetMesh, TriangleCount, Options,
                                                                                   Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSimplifyFunctions:ApplySimplifyToPolygroupTopology(TargetMesh, Options, GroupLayer,
                                                                                       Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSpatial:SelectMeshElementsInBoxWithBVH(TargetMesh, QueryBVH, QueryBox, Options,
                                                                           Selection, SelectionType, MinNumTrianglePoints,
                                                                           Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSpatial:IsPointInsideMesh(TargetMesh, QueryBVH, QueryPoint, Options, bIsInside,
                                                              Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSpatial:FindNearestRayIntersectionWithMesh(TargetMesh, QueryBVH, RayOrigin,
                                                                               RayDirection, Options, HitResult, Outcome,
                                                                               Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSpatial:FindNearestPointOnMesh(TargetMesh, QueryBVH, QueryPoint, Options,
                                                                   NearestResult, Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshSubdivideFunctions:ApplySelectiveTessellation(TargetMesh, Selection, Options,
                                                                                  TessellationLevel, PatternType, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshTransformFunctions:TransformMesh(TargetMesh, Transform,
                                                                     bFixOrientationForNegativeScale, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshTransformFunctions:ScaleMeshSelection(TargetMesh, Selection, Scale, ScaleOrigin,
                                                                          Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshTransformFunctions:ScaleMesh(TargetMesh, Scale, ScaleOrigin,
                                                                 bFixOrientationForNegativeScale, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshTransformFunctions:RotateMeshSelection(TargetMesh, Selection, Rotation,
                                                                           RotationOrigin, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:SetMeshUVsFromPlanarProjection(TargetMesh, UvSetIndex, PlaneTransform,
                                                                               Selection, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:SetMeshUVsFromCylinderProjection(TargetMesh, UvSetIndex,
                                                                                 CylinderTransform, Selection, SplitAngle,
                                                                                 Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:SetMeshUVsFromBoxProjection(TargetMesh, UvSetIndex, BoxTransform,
                                                                            Selection, MinIslandTriCount, Debug) end
...
---@param bDeferChangeNotifications boolean
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:SetMeshTriangleUVs(TargetMesh, UvSetIndex, TriangleID, UVs,
                                                                   bIsValidTriangle, bDeferChangeNotifications) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:RotateMeshUVs(TargetMesh, UvSetIndex, RotationAngle, RotationOrigin,
                                                              Selection, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:GetMeshUVSizeInfo(TargetMesh, UvSetIndex, Selection, MeshArea, UVArea,
                                                                  MeshBounds, UVBounds, bIsValidUVSet, bFoundUnsetUVs,
                                                                  bOnlyIncludeValidUVTris, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:GetMeshPerVertexUVs(TargetMesh, UvSetIndex, UVList, bIsValidUVSet,
                                                                    bHasVertexIDGaps, bHasSplitUVs, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:CopyMeshUVLayerToMesh(CopyFromMesh, UvSetIndex, CopyToUVMesh,
                                                                      CopyToUVMeshOut, bInvalidTopology, bIsValidUVSet,
                                                                      Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:CopyMeshToMeshUVLayer(CopyFromUVMesh, ToUVSetIndex, CopyToMesh,
                                                                      CopyToMeshOut, bFoundTopologyErrors, bIsValidUVSet,
                                                                      bOnlyUVPositions, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshUVFunctions:ComputeMeshLocalUVParam(TargetMesh, CenterPoint, CenterPointTriangleID,
                                                                        VertexIDs, VertexUVs, Radius,
                                                                        bUseInterpolatedNormal, TangentYDirection,
                                                                        UVRotationDeg, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshVertexColorFunctions:SetMeshSelectionVertexColor(TargetMesh, Selection, Color, Flags,
                                                                                     bCreateColorSeam, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshVertexColorFunctions:SetMeshConstantVertexColor(TargetMesh, Color, Flags,
                                                                                    bClearExisting, Debug) end
...
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshVertexColorFunctions:GetMeshPerVertexColors(TargetMesh, ColorList, bIsValidColorSet,
                                                                                bHasVertexIDGaps, bBlendSplitVertexValues) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_MeshVertexColorFunctions:BlurMeshVertexColors(TargetMesh, Selection, NumIterations,
                                                                              Strength, BlurMode, Options, Debug) end
...
function UGeometryScriptLibrary_PolyPathFunctions:SampleSplineToTransforms(Spline, Frames, FrameTimes, SamplingOptions,
                                                                           RelativeTransform, bIncludeScale) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:PolygonsOffsets(PolygonList, OffsetOptions, FirstOffset,
                                                                     SecondOffset, bOperationSuccess, bCopyInputOnFailure) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:PolygonsOffset(PolygonList, OffsetOptions, Offset, bOperationSuccess,
                                                                    bCopyInputOnFailure) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:PolygonsMorphologyOpen(PolygonList, OffsetOptions, Offset,
                                                                            bOperationSuccess, bCopyInputOnFailure) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:PolygonsMorphologyClose(PolygonList, OffsetOptions, Offset,
                                                                             bOperationSuccess, bCopyInputOnFailure) end
...
---@param PolygonIndex int32
---@param HoleIndex int32
function UGeometryScriptLibrary_PolygonListFunctions:GetPolygonVertices(PolygonList, OutVertices, bValidIndices,
                                                                        PolygonIndex, HoleIndex) end
...
---@param HoleIndex int32
---@return int32
function UGeometryScriptLibrary_PolygonListFunctions:GetPolygonVertexCount(PolygonList, bValidIndices, PolygonIndex,
                                                                           HoleIndex) end
...
---@param HoleIndex int32
---@return FVector2D
function UGeometryScriptLibrary_PolygonListFunctions:GetPolygonVertex(PolygonList, bIsValidVertex, VertexIndex,
                                                                      PolygonIndex, HoleIndex) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:CreatePolygonsFromPathOffset(Path, OffsetOptions, Offset,
                                                                                  bOperationSuccess, bCopyInputOnFailure) end
...
---@param bCopyInputOnFailure boolean
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:CreatePolygonsFromOpenPolyPathsOffset(PolyPaths, OffsetOptions,
                                                                                           Offset, bOperationSuccess,
                                                                                           bCopyInputOnFailure) end
...
---@return FGeometryScriptGeneralPolygonList
function UGeometryScriptLibrary_PolygonListFunctions:CreatePolygonListFromSinglePolygon(OuterPolygon, HolePolygons,
                                                                                        bFixHoleOrientations) end
...
---@param bFixHoleOrientations boolean
---@return int32
function UGeometryScriptLibrary_PolygonListFunctions:AddPolygonToList(PolygonList, OuterPolygon, HolePolygons,
                                                                      bFixHoleOrientations) end
...
---@return boolean
function UGeometryScriptLibrary_RayFunctions:GetRaySphereIntersection(Ray, SphereCenter, SphereRadius, Distance1,
                                                                      Distance2) end
...
---@return double
function UGeometryScriptLibrary_RayFunctions:GetRaySegmentClosestPoint(Ray, SegStartPoint, SegEndPoint, RayParameter,
                                                                       RayPoint, SegPoint) end
...
---@return double
function UGeometryScriptLibrary_RayFunctions:GetRayLineClosestPoint(Ray, LineOrigin, LineDirection, RayParameter,
                                                                    RayPoint, LineParameter, LinePoint) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_SceneUtilityFunctions:CopyMeshFromComponent(Component, ToDynamicMesh, Options,
                                                                            bTransformToWorld, LocalToWorld, Outcome,
                                                                            Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_SceneUtilityFunctions:CopyCollisionMeshesFromObject(FromObject, ToDynamicMesh,
                                                                                    bTransformToWorld, LocalToWorld,
                                                                                    Outcome, bUseComplexCollision,
                                                                                    SphereResolution, Debug) end
...
---@param Outcome EGeometryScriptOutcomePins
---@param Debug UGeometryScriptDebug
function UGeometryScriptLibrary_StaticMeshFunctions:GetSectionMaterialListFromStaticMesh(FromStaticMeshAsset,
                                                                                         RequestedLOD, MaterialList,
                                                                                         MaterialIndex, Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_StaticMeshFunctions:CopyMeshToStaticMesh(FromDynamicMesh, ToStaticMeshAsset, Options,
                                                                         TargetLod, Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_StaticMeshFunctions:CopyMeshToSkeletalMesh(FromDynamicMesh, ToSkeletalMeshAsset, Options,
                                                                           TargetLod, Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_StaticMeshFunctions:CopyMeshFromStaticMesh(FromStaticMeshAsset, ToDynamicMesh,
                                                                           AssetOptions, RequestedLOD, Outcome, Debug) end
...
---@param Debug UGeometryScriptDebug
---@return UDynamicMesh
function UGeometryScriptLibrary_StaticMeshFunctions:CopyMeshFromSkeletalMesh(FromSkeletalMeshAsset, ToDynamicMesh,
                                                                             AssetOptions, RequestedLOD, Outcome, Debug) end
...
---@param ColorList FGeometryScriptColorList
---@param Debug UGeometryScriptDebug
function UGeometryScriptLibrary_TextureMapFunctions:SampleTextureRenderTarget2DAtUVPositions(UVList, Texture,
                                                                                             SampleOptions, ColorList,
                                                                                             Debug) end
...
---@param ColorList FGeometryScriptColorList
---@param Debug UGeometryScriptDebug
function UGeometryScriptLibrary_TextureMapFunctions:SampleTexture2DAtUVPositions(UVList, Texture, SampleOptions,
                                                                                 ColorList, Debug) end
