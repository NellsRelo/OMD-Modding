...
UW_HUD_Reticle_C['Tick Progress Bar'] = function() end
---@param Tags FGameplayTagContainer
UW_HUD_Reticle_C['Play Hit'] = function(Tags) end
UW_HUD_Reticle_C['Listen For Hit Messages'] = function() end
---@param Style TSubclassOf<UCommonTextStyle>
---@param Priority int32
UW_HUD_Reticle_C['Trigger Hit Indicator'] = function(Style, Priority) end
