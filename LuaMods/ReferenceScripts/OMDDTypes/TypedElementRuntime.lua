...
ITypedElementPrimitiveCustomDataInterface = {}

---@param InElementHandle FScriptTypedElementHandle
---@param CustomDataIndex int32
---@param CustomDataValue float
---@param bMarkRenderStateDirty boolean
function ITypedElementPrimitiveCustomDataInterface:SetCustomDataValue(InElementHandle, CustomDataIndex, CustomDataValue,
