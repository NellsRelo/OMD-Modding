...
---@param RequestedPrivilege ECommonUserPrivilege
---@param OnlineContext ECommonUserOnlineContext
function UW_StartupScreen_C:OnInitializationComplete_5C53736C4ABACCDB6BAF16B1DF082148(UserInfo, bSuccess, Error,
                                                                                      RequestedPrivilege, OnlineContext) end

---@param Button UCommonButtonBase
function UW_StartupScreen_C:BndEvt__W_StartupScreen_PressStartButton_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(
    Button) end
