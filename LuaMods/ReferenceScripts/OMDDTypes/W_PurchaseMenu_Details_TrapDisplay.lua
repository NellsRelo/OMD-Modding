...
UW_PurchaseMenu_Details_TrapDisplay_C['Get Trap Placement Type Texture'] = function(self, InventoryItem,
                                                                                    Trap_Placement_Texture) end
---@param NameText FText
---@param ValueText FText
---@param UpgradeLevel int32
---@param PreviewUpgradeLevel int32
---@param IsModified boolean
function UW_PurchaseMenu_Details_TrapDisplay_C:AddDetailsRow(NameText, ValueText, UpgradeLevel, PreviewUpgradeLevel,
                                                             IsModified) end

UW_PurchaseMenu_Details_TrapDisplay_C['Init Display'] = function(self,) end
---@param ProxyObject UAsyncAction_ListenForGameplayMessage
---@param ActualChannel FGameplayTag
function UW_PurchaseMenu_Details_TrapDisplay_C:OnMessageReceived_AECAF5C04599D0D1021B328B8A95FFBC(ProxyObject,
                                                                                                  ActualChannel) end
