...
UW_MissionStats_Entry_C['On Upgrades Changed'] = function(self, PlayerId, Upgrade) end
UW_MissionStats_Entry_C['Update Level Display'] = function(self,) end
---@return boolean
UW_MissionStats_Entry_C['Is Online Game'] = function(self,) end
...
UW_MissionStats_Entry_C['Set Run Stats'] = function(self, In_Run_Stats) end
UW_MissionStats_Entry_C['Set Player Display'] = function(self,) end
UW_MissionStats_Entry_C['Set Party Leader Display'] = function(self,) end
---@param InputPin URSTPawnUserFacingData
UW_MissionStats_Entry_C['Set Pawn Icon'] = function(self, InputPin) end
