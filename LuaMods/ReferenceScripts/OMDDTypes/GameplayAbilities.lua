...
---@field LoadedGameplayCueClass TObjectPtr<UClass>
...
---@field CameraShakeSource EGameplayCueNotify_LocallyControlledSource
---@field bOverrideSpawnCondition boolean
---@field bOverridePlacementInfo boolean
---@field bPlayInWorld boolean
---@field WorldInnerRadius float
...
---@field bInvertDecalRotation boolean
---@field bRandomizeRotation boolean
---@field RandomRotation FGameplayCueNotify_RandomRotation
---@field bUniformRandomScaling boolean
---@field UniformRandomScale FGameplayCueNotify_RandomUniformScale
---@field bRandomizeXScale boolean
---@field RandomXScale FGameplayCueNotify_RandomScale
---@field bRandomizeYScale boolean
---@field RandomYScale FGameplayCueNotify_RandomScale
---@field bRandomizeZScale boolean
---@field RandomZScale FGameplayCueNotify_RandomScale
...
---@class FGameplayCueNotify_RandomRotation
---@field MinVal double
---@field MaxVal double
---@field Rot FRotator
FGameplayCueNotify_RandomRotation = {}



---@class FGameplayCueNotify_RandomScale
---@field MinVal double
---@field MaxVal double
---@field bApplyRelative boolean
FGameplayCueNotify_RandomScale = {}



---@class FGameplayCueNotify_RandomUniformScale
---@field MinVal double
---@field MaxVal double
---@field bApplyRelative boolean
---@field bModifyX boolean
---@field bModifyY boolean
---@field bModifyZ boolean
FGameplayCueNotify_RandomUniformScale = {}
...
---@field TagParameters TArray<FGameplayTagPair>
...
FMinimalGameplayCueReplicationProxyForNetSerializer = {}
...
---@field Tags TArray<FGameplayTag>
FMinimalReplicationTagCountMapForNetSerializer = {}
...
---@field PreallocatedInstances TMap<TObjectPtr<UClass>, FGameplayCueNotifyActorArray>
...
---@field bPostFinishSyncEveryFrame boolean
---@field NumPostFinishTicks int32
...
---@field OnExecutionGameplayEffects TArray<FConditionalGameplayEffect>
...
---@field LoadedGameplayCueNotifyClasses TArray<TObjectPtr<UClass>>
