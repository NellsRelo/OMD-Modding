...
UGA_Hammer_Ultimate_C['Start Glyph'] = function() end
UGA_Hammer_Ultimate_C['Anim Finished'] = function() end
UGA_Hammer_Ultimate_C['Start Delay'] = function() end
UGA_Hammer_Ultimate_C['Finish Glyph'] = function() end
UGA_Hammer_Ultimate_C['Apply Tags'] = function() end
UGA_Hammer_Ultimate_C['Remove Tags'] = function() end
UGA_Hammer_Ultimate_C['Apply Damage Buff'] = function() end
UGA_Hammer_Ultimate_C['Remove Damage Buff'] = function() end
UGA_Hammer_Ultimate_C['Apply Player Buffs'] = function() end
UGA_Hammer_Ultimate_C['Remove Player Buffs'] = function() end
UGA_Hammer_Ultimate_C['Execute Application Effects'] = function() end
...
---@param Target AActor
UGA_Hammer_Ultimate_C['Apply Damage to Target'] = function(Target) end
