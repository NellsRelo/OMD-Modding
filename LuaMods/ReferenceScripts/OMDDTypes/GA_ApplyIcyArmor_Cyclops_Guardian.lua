...
UGA_ApplyIcyArmor_Cyclops_Guardian_C['Make Buff Spec'] = function(GameplayEffectClass, Duration) end
---@param Targets TArray<UObject>
---@param Duration double
UGA_ApplyIcyArmor_Cyclops_Guardian_C['Apply Buffs'] = function(Targets, Duration) end
...
UGA_ApplyIcyArmor_Cyclops_Guardian_C['Try End Ability'] = function() end
UGA_ApplyIcyArmor_Cyclops_Guardian_C['Reset End Conditions'] = function() end
UGA_ApplyIcyArmor_Cyclops_Guardian_C['Clear Target Processing Task'] = function() end
