...
---@field KeyTextFont FSlateFontInfo
---@field KeyTextColor FSlateColor
---@field KeyTextStretchMethod EStretch::Type
---@field KeyTextStretchDirection EStretchDirection::Type
---@field KeyTextMargin FMargin
---@field HeldStaticDisplayMargin FMargin
---@field bUseHeldStaticDisplay boolean
---@field HeldStaticDisplayBrush FSlateBrush
