...
function ABP_BombDispenser_Projectile_C:BndEvt__BP_BombDispenser_Projectile_ProjectileMovementComponent_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature(ImpactResult) end
...
function ABP_BombDispenser_Projectile_C:ReceiveHit(MyComp, Other, OtherComp, bSelfMoved, HitLocation, HitNormal, NormalImpulse, Hit) end
