...
---@class ABP_Colosseum_Column_Limestone_1_2_B_C : ABP_OMDTrapGrid_C
---@field NavPowerExclusion UNavPowerExclusionComponent
---@field Colosseum_Column_Limestone_1_2_B_SM UStaticMeshComponent
...
ABP_Colosseum_Column_Limestone_1_2_B_C = {}
