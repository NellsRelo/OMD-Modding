...
function UW_PostGameMenu_C:BndEvt__W_RSTInGameMenu_ReturnToHub_K2Node_ComponentBoundEvent_2_CommonButtonBaseClicked__DelegateSignature(
    Button) end

function UW_PostGameMenu_C:Construct() end

---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_GambleForward_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(
    Button) end

function UW_PostGameMenu_C:BP_OnActivated() end

---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_Stats_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature(
    Button) end
...
---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_MissionStats_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_Quicksave_K2Node_ComponentBoundEvent_4_CommonButtonBaseClicked__DelegateSignature(
    Button) end
...
UW_PostGameMenu_C['Init Rift Bonus Display'] = function(self, bDidWin) end
---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_AbandonRun_K2Node_ComponentBoundEvent_5_CommonButtonBaseClicked__DelegateSignature(
    Button) end
...
---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_GambleForward_K2Node_ComponentBoundEvent_6_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_PostGameMenu_C:BndEvt__W_PostGameMenu_GambleForward_K2Node_ComponentBoundEvent_7_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param bHovered boolean
UW_PostGameMenu_C['Set Rift Blessing Hover State'] = function(self, bHovered) end
---@param Text FText
