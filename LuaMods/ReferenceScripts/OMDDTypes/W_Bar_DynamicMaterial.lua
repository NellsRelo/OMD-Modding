...
UW_Bar_DynamicMaterial_C['Get Normalized Current Value'] = function(NormalizedValue) end
---@param Value double
---@param NormalizedValue double
...
UW_Bar_DynamicMaterial_C['Update Bar Colors'] = function() end
---@param BarForegroundColor FLinearColor
UW_Bar_DynamicMaterial_C['Set Bar Foreground Color'] = function(BarForegroundColor) end
---@param BarBackgroundColor FLinearColor
UW_Bar_DynamicMaterial_C['Set Bar Background Color'] = function(BarBackgroundColor) end
