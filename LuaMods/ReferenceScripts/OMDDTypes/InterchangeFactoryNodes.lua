...
function UInterchangeAnimSequenceFactoryNode:SetAnimationPayloadKeysForSceneNodeUids(SceneNodeAnimationPayloadKeyUids,
                                                                                     SceneNodeAnimationPayloadKeyTypes) end
...
function UInterchangeAnimSequenceFactoryNode:SetAnimationPayloadKeysForMorphTargetNodeUids(
    MorphTargetAnimationPayloadKeyUids, MorphTargetAnimationPayloadKeyTypes) end
