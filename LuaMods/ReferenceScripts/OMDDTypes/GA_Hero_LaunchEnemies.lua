...
---@param Target AActor
---@return FVector
UGA_Hero_LaunchEnemies_C['Get Launch Direction'] = function(self, Target) end
---@param Target AActor
---@param Value double
UGA_Hero_LaunchEnemies_C['Get Weight Class Speed Modifier'] = function(self, Target, Value) end
---@param Target AActor
---@param Value ERSTCharacterWeightClass
---@param bFound boolean
UGA_Hero_LaunchEnemies_C['Get Override Max Weight Class'] = function(self, Target, Value, bFound) end
---@param Target AActor
---@param Value double
---@param bFound boolean
UGA_Hero_LaunchEnemies_C['Get Tagged Speed Modifier'] = function(self, Target, Value, bFound) end
---@param LaunchedActor AActor
---@param AdjustedSpeed double
UGA_Hero_LaunchEnemies_C['Get Launch Speed'] = function(self, LaunchedActor, AdjustedSpeed) end
---@param Target AActor
UGA_Hero_LaunchEnemies_C['Try Launch Target'] = function(self, Target) end
---@param Target AActor
---@param bShouldLaunch boolean
UGA_Hero_LaunchEnemies_C['Should Launch Target'] = function(self, Target, bShouldLaunch) end
---@param Target AActor
---@return FVector
UGA_Hero_LaunchEnemies_C['Get Launch Velocity'] = function(self, Target) end
...
UGA_Hero_LaunchEnemies_C['Do Launch Character'] = function(self, InToLaunchCharacter, InLaunchVelocity) end
