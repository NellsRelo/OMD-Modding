...
UW_MissionStats_Award_C['Set Pawn Icon'] = function(self, InputPin) end
UW_MissionStats_Award_C['Init Player Display'] = function(self,) end
UW_MissionStats_Award_C['Initialize Accolade'] = function(self,) end
