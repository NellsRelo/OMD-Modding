...
---@return boolean
UGA_Daggers_Secondary_Combat_C['Is Airborne'] = function(self,) end
...
UGA_Daggers_Secondary_Combat_C['Calculate Launch Parameters'] = function(self, Location, Direction, Angles, Fire_Data) end
...
UGA_Daggers_Secondary_Combat_C['Calculate Projectile Angles'] = function(self, OutAngles) end
---@param ActorInfo FGameplayAbilityActorInfo
---@param Handle FGameplayAbilitySpecHandle
...
UGA_Daggers_Secondary_Combat_C['Apply Aerial Hang'] = function(self,) end
UGA_Daggers_Secondary_Combat_C['Remove Aerial Hang'] = function(self,) end
