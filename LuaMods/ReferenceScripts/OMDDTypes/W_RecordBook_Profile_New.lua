...
UW_RecordBook_Profile_New_C['Populate From Tag Data'] = function(Name, BrushObject) end
---@param Seconds float
---@param Result FText
...
UW_RecordBook_Profile_New_C['Populate Profile Name'] = function() end
UW_RecordBook_Profile_New_C['Populate Profile Level'] = function() end
UW_RecordBook_Profile_New_C['Populate Time Played'] = function() end
UW_RecordBook_Profile_New_C['Populate Hero'] = function() end
UW_RecordBook_Profile_New_C['Populate Trap'] = function() end
