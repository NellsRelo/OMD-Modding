...
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_7(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_6(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_5(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_4(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_3(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_2(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_1(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:CREATEDELEGATE_PROXYFUNCTION_0(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param OwningActor AActor
---@param Instigator AActor
UW_StatDisplay_Base_C['On Death State Updated'] = function(OwningActor, Instigator) end
---@param bDowned boolean
UW_StatDisplay_Base_C['Refresh Downed Display'] = function(bDowned) end
---@return URSTAbilitySystemComponent
UW_StatDisplay_Base_C['Get Current Ability System Component'] = function() end
---@param Val double
---@param ReturnVal FText
UW_StatDisplay_Base_C['Float to Rounded Int Text'] = function(Val, ReturnVal) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:OnPlayerCharacterShieldMaxChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:OnPlayerCharacterShieldChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:OnPlayerCharacterHealthMaxChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
---@param HealthComponent URSTHealthComponent
---@param OldValue float
---@param NewValue float
---@param Instigator AActor
...
---@param bHasSpec boolean
---@param Spec FGameplayEffectSpec
function UW_StatDisplay_Base_C:OnPlayerCharacterHealthChanged(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
