...
---@field bHasSetupButtons boolean
UW_RSTInGameMenu_C = {}
...
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_Exit_K2Node_ComponentBoundEvent_0_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_ExitPIE_K2Node_ComponentBoundEvent_1_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_ReturnToHub_K2Node_ComponentBoundEvent_2_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_SettingsTodo_K2Node_ComponentBoundEvent_3_CommonButtonBaseClicked__DelegateSignature(
    Button) end
...
---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_Social_K2Node_ComponentBoundEvent_4_CommonButtonBaseClicked__DelegateSignature(
    Button) end

---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_CharacterSelect_K2Node_ComponentBoundEvent_5_CommonButtonBaseClicked__DelegateSignature(
    Button) end
...
---@param Button UCommonButtonBase
function UW_RSTInGameMenu_C:BndEvt__W_RSTInGameMenu_Resume_K2Node_ComponentBoundEvent_6_CommonButtonBaseClicked__DelegateSignature(
    Button) end

function UW_RSTInGameMenu_C:BP_OnActivated() end

UW_RSTInGameMenu_C['Remove UI IMC'] = function(self,) end
...
function UW_RSTInGameMenu_C:SetupButtonImages() end
