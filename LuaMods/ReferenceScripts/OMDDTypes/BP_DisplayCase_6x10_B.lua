...
---@class ABP_DisplayCase_6x10_B_C : ABP_OMDTrapGrid_C
---@field BP_Skeleton_HellBat_Momma_Breakable UChildActorComponent
---@field BP_Statue_Raven_Base_Breakable1 UChildActorComponent
---@field BP_Statue_Raven_Base_Breakable UChildActorComponent
---@field BP_Orc_Horn2_Breakable UChildActorComponent
---@field BP_Orc_TotemCross_Breakable UChildActorComponent
---@field BP_Orc_WarCampShield_Breakable UChildActorComponent
---@field BP_Orc_Totem_A_Breakable UChildActorComponent
---@field BP_Orc_Totem_B_Breakable UChildActorComponent
---@field BP_Orc_Totem_C_Breakable UChildActorComponent
