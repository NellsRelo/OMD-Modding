...
UGA_Wand_Reload_C['Bonus Input Pressed'] = function() end
function UGA_Wand_Reload_C:K2_OnAbilityAdded() end
UGA_Wand_Reload_C['Get Notify Windows'] = function() end
function UGA_Wand_Reload_C:K2_ActivateAbility() end
UGA_Wand_Reload_C['Start Bonus Window Timer'] = function() end
UGA_Wand_Reload_C['Open Bonus Window'] = function() end
UGA_Wand_Reload_C['Close Bonus Window'] = function() end
UGA_Wand_Reload_C['Reset Values'] = function() end
---@param bWasCancelled boolean
function UGA_Wand_Reload_C:K2_OnEndAbility(bWasCancelled) end
---@param inInt int32
UGA_Wand_Reload_C['Apply Bonus Buff'] = function(inInt) end
UGA_Wand_Reload_C['Perform Auth Reload'] = function() end
UGA_Wand_Reload_C['Start Input Task'] = function() end
UGA_Wand_Reload_C['Notify Server if Bonus Granted'] = function() end
UGA_Wand_Reload_C['Clear Input Task'] = function() end
