...
UGA_Max_Ultimate_Secondary_C['Get Impact Location'] = function(Impact_Location) end
---@param LaunchedActor AActor
---@param AdjustedSpeed double
UGA_Max_Ultimate_Secondary_C['Get Launch Speed'] = function(LaunchedActor, AdjustedSpeed) end
---@param Target AActor
---@return FVector
UGA_Max_Ultimate_Secondary_C['Get Launch Direction'] = function(Target) end
---@param bCanFinishAbility boolean
UGA_Max_Ultimate_Secondary_C['Can Finish Ability'] = function(bCanFinishAbility) end
...
UGA_Max_Ultimate_Secondary_C['Post Execute'] = function() end
UGA_Max_Ultimate_Secondary_C['On Montage Finished'] = function() end
UGA_Max_Ultimate_Secondary_C['On Montage Cancelled'] = function() end
UGA_Max_Ultimate_Secondary_C['Try Finish Ability'] = function() end
