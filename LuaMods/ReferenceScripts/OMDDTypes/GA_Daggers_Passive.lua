...
UGA_Daggers_Passive_C['Get Skeleton Target'] = function(self, Actors) end
---@param Actors TArray<AActor>
UGA_Daggers_Passive_C['Gather Player Targets'] = function(self, Actors) end
---@param HealAmount double
UGA_Daggers_Passive_C['Apply Heal Effect'] = function(self, HealAmount) end
---@param Message FRSTDamageMessage
UGA_Daggers_Passive_C['Process Message Received'] = function(self, Message) end
