...
---@return USoundWave
function UAudioMixerBlueprintLibrary:StopRecordingOutput(WorldContextObject, ExportType, Name, Path, SubmixToRecord,
                                                         ExistingSoundWaveToOverwrite) end
...
function UAudioMixerBlueprintLibrary:StartAnalyzingOutput(WorldContextObject, SubmixToAnalyze, FFTSize,
                                                          InterpolationMethod, WindowType, HopSize, SpectrumType) end

---@param WorldContextObject UObject
---@param SoundSubmix USoundSubmix
---@param SubmixEffectPresetChain TArray<USoundEffectSubmixPreset>
---@param FadeTimeSec float
function UAudioMixerBlueprintLibrary:SetSubmixEffectChainOverride(WorldContextObject, SoundSubmix,
                                                                  SubmixEffectPresetChain, FadeTimeSec) end

---@param WorldContextObject UObject
---@param PresetChain USoundEffectSourcePresetChain
---@param EntryIndex int32
---@param bBypassed boolean
function UAudioMixerBlueprintLibrary:SetBypassSourceEffectChainEntry(WorldContextObject, PresetChain, EntryIndex,
                                                                     bBypassed) end
...
function UAudioMixerBlueprintLibrary:ReplaceSubmixEffect(WorldContextObject, InSoundSubmix, SubmixChainIndex,
                                                         SubmixEffectPreset) end

---@param WorldContextObject UObject
---@param InSoundSubmix USoundSubmix
---@param SubmixChainIndex int32
---@param SubmixEffectPreset USoundEffectSubmixPreset
function UAudioMixerBlueprintLibrary:ReplaceSoundEffectSubmix(WorldContextObject, InSoundSubmix, SubmixChainIndex,
                                                              SubmixEffectPreset) end
...
function UAudioMixerBlueprintLibrary:MakePresetSpectralAnalysisBandSettings(InBandPresetType, InNumBands,
                                                                            InAttackTimeMsec, InReleaseTimeMsec) end
...
---@param InReleaseTimeMsec int32
---@return TArray<FSoundSubmixSpectralAnalysisBandSettings>
function UAudioMixerBlueprintLibrary:MakeMusicalSpectralAnalysisBandSettings(InNumSemitones, InStartingMusicalNote,
                                                                             InStartingOctave, InAttackTimeMsec,
                                                                             InReleaseTimeMsec) end
...
---@param InReleaseTimeMsec int32
---@return TArray<FSoundSubmixSpectralAnalysisBandSettings>
function UAudioMixerBlueprintLibrary:MakeFullSpectrumSpectralAnalysisBandSettings(InNumBands, InMinimumFrequency,
                                                                                  InMaximumFrequency, InAttackTimeMsec,
                                                                                  InReleaseTimeMsec) end
...
---@param SubmixToAnalyze USoundSubmix
function UAudioMixerBlueprintLibrary:GetMagnitudeForFrequencies(WorldContextObject, Frequencies, Magnitudes,
                                                                SubmixToAnalyze) end
...
---@param ClockHandle UQuartzClockHandle
function UQuartzClockHandle:SubscribeToQuantizationEvent(WorldContextObject, InQuantizationBoundary, OnQuantizationEvent,
                                                         ClockHandle) end
...
function UQuartzClockHandle:SetTicksPerSecond(WorldContextObject, QuantizationBoundary, Delegate, ClockHandle,
                                              TicksPerSecond) end
...
function UQuartzClockHandle:SetThirtySecondNotesPerMinute(WorldContextObject, QuantizationBoundary, Delegate, ClockHandle,
                                                          ThirtySecondsNotesPerMinute) end
...
function UQuartzClockHandle:SetSecondsPerTick(WorldContextObject, QuantizationBoundary, Delegate, ClockHandle,
                                              SecondsPerTick) end
...
function UQuartzClockHandle:SetMillisecondsPerTick(WorldContextObject, QuantizationBoundary, Delegate, ClockHandle,
                                                   MillisecondsPerTick) end
...
function UQuartzClockHandle:SetBeatsPerMinute(WorldContextObject, QuantizationBoundary, Delegate, ClockHandle,
                                              BeatsPerMinute) end
...
function UQuartzClockHandle:NotifyOnQuantizationBoundary(WorldContextObject, InQuantizationBoundary, InDelegate,
                                                         InMsOffset) end
...
---@param Multiplier float
---@return float
function UQuartzSubsystem:GetDurationOfQuantizationTypeInSeconds(WorldContextObject, ClockName, QuantizationType,
                                                                 Multiplier) end
...
---@return UQuartzClockHandle
function UQuartzSubsystem:CreateNewClock(WorldContextObject, ClockName, InSettings, bOverrideSettingsIfClockExists,
                                         bUseAudioEngineClockManager) end
