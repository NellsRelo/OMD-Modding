...
UW_PurchaseMenu_TrapUpgrade_C['Perform No Button Clicked'] = function(self,) end
---@param bUseEmptyText boolean
---@param Empty_Text FText
UW_PurchaseMenu_TrapUpgrade_C['Get Empty Text'] = function(self, bUseEmptyText, Empty_Text) end
---@param Element UObject
---@param Should_Enable boolean
UW_PurchaseMenu_TrapUpgrade_C['Should Element Be Spawned'] = function(self, Element, Should_Enable) end
UW_PurchaseMenu_TrapUpgrade_C['Perform Yes Button Clicked'] = function(self,) end
---@param Yes_Visibility ESlateVisibility
UW_PurchaseMenu_TrapUpgrade_C['Can Show Yes Button'] = function(self, Yes_Visibility) end
...
UW_PurchaseMenu_TrapUpgrade_C['BndEvt__W_PurchaseMenu_Trap_W_RSTSpellbook_CategorySwitcher_K2Node_ComponentBoundEvent_0_On Category Selected__DelegateSignature'] = function(
    self, Category) end
UW_PurchaseMenu_TrapUpgrade_C['Load Grid Objects'] = function(self,) end
---@param NPC ABP_NPCInteractable_C
function UW_PurchaseMenu_TrapUpgrade_C:OnWidgetOpened(NPC) end

---@param Object UObject
UW_PurchaseMenu_TrapUpgrade_C['On Object Selected'] = function(self, Object) end
