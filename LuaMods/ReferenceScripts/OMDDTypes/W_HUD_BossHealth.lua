...
UW_HUD_BossHealth_C['On Health Changed'] = function(HealthComponent, OldValue, NewValue, Instigator, HitResult, bHasSpec, Spec) end
UW_HUD_BossHealth_C['Stop All Animations'] = function() end
---@param TransitionTag FGameplayTag
---@param AdditionalTags FGameplayTagContainer
UW_HUD_BossHealth_C['On Transition Finished'] = function(TransitionTag, AdditionalTags) end
UW_HUD_BossHealth_C['Show UI'] = function() end
