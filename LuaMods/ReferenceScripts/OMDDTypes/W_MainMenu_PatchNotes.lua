...
UW_MainMenu_PatchNotes_C['BndEvt__W_SessionBrowser_W_ExitMenuButton_K2Node_ComponentBoundEvent_3_On Button Clicked__DelegateSignature'] = function(
    self,) end
...
---@param Value float
function UW_MainMenu_PatchNotes_C:BndEvt__W_MainMenu_PatchNotes_ScrollBarSlider_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature(
    Value) end

---@param CurrentOffset float
function UW_MainMenu_PatchNotes_C:BndEvt__W_MainMenu_PatchNotes_ScrollBox_K2Node_ComponentBoundEvent_1_OnUserScrolledEvent__DelegateSignature(
    CurrentOffset) end
