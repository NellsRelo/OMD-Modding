...
---@return FVector
UGA_Gabby_Passive_C['Get Blink Velocity'] = function(self,) end
...
UGA_Gabby_Passive_C['Try End Ability'] = function(self,) end
UGA_Gabby_Passive_C['Input Released'] = function(self,) end
UGA_Gabby_Passive_C['Perform Blink'] = function(self,) end
UGA_Gabby_Passive_C['Apply Collision Overrides'] = function(self,) end
UGA_Gabby_Passive_C['Remove Collision Overrides'] = function(self,) end
UGA_Gabby_Passive_C['On Blink Finished'] = function(self,) end
UGA_Gabby_Passive_C['Perform Origin AOE'] = function(self,) end
