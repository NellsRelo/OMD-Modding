...
---@class ABP_CastlePlaza_Wall_Half_1x4_A_Merged_C : ABP_OMDTrapGrid_C
---@field NavPowerExclusion UNavPowerExclusionComponent
---@field SM_CastlePlaza_Wall_Half_1x4_A_Merged UStaticMeshComponent
...
ABP_CastlePlaza_Wall_Half_1x4_A_Merged_C = {}
