...
function UDLSSLibrary:GetDLSSModeInformation(DLSSMode, ScreenResolution, bIsSupported, OptimalScreenPercentage,
                                             bIsFixedScreenPercentage, MinScreenPercentage, MaxScreenPercentage,
                                             OptimalSharpness) end
