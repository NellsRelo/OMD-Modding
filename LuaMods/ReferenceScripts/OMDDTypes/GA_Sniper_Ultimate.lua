...
UGA_Sniper_Ultimate_C['Get Valid Targets'] = function(self, Targets) end
...
UGA_Sniper_Ultimate_C['Execute Application Effects'] = function(self,) end
function UGA_Sniper_Ultimate_C:RequestDialogue() end

UGA_Sniper_Ultimate_C['Start Reacquiring Targets'] = function(self,) end
UGA_Sniper_Ultimate_C['Stop Reacquiring Targets'] = function(self,) end
UGA_Sniper_Ultimate_C['Try Reacquire Targets'] = function(self,) end
UGA_Sniper_Ultimate_C['Try Acquire Hub Coordinator'] = function(self,) end
