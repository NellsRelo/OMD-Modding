...
UW_RecordBook_HeroSwitcherButton_C['Load Hero Texture'] = function() end
...
UW_RecordBook_HeroSwitcherButton_C['Refresh Button Visuals'] = function() end
...
UW_RecordBook_HeroSwitcherButton_C['On Filter Clicked__DelegateSignature'] = function(ThisButton) end
