...
---@class UNiagaraDataInterfaceFieldSystem : UNiagaraDataInterface
---@field BlueprintSource UBlueprint
---@field SourceActor AActor
---@field FieldDimensions FIntVector
---@field MinBounds FVector
---@field MaxBounds FVector
